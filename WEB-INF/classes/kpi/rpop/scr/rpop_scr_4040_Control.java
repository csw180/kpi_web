...
/**
 *  클래스 개요     : 기업금융센터 kpi총괄실적 조회  <p>
 *  클래스 상세기능 : 기업금융센터 kpi총괄실적을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2009.03.19<p>
 *  @version 1.0
 *  @author  조형석
 */
public class rpop_scr_4040_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            procName = "UP_KPI_M_S_기업금융센터kpi총괄실적" + basemonth.substring(0,4);
