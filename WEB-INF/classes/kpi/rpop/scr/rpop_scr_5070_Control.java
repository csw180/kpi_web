...
/**
 *  클래스 개요    : 우수직원실적평가 조회  <p>
 *  클래스 상세기능 : 우수직원실적평가 보고서를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2014.04.21<p>
 *  @version 1.0
 *  @author  박아란
 */
public class rpop_scr_5070_Control extends HTMLActionSupport   
{
      /**
       * HttpRequst의 정보를 우수직원실적평가 조회 데이타모델로 파싱하여 반환한다.
       */
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_우수직원실적평가", basemonth);
