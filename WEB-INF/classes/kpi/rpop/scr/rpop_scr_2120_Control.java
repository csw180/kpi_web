...
/*----------------------------------------------------------
 *  클래스 개요     : NIM(영업점 순이자마진율) 조회
 *  클래스 상세기능 : NIM(영업점 순이자마진율)
 *  작성일 : 2012.03.06
 *  @version 1.1
 *  @author  하진영 : 이익상세를 기준으로 마진율 산출
 ------------------------------------------------------------*/
 
public class rpop_scr_2120_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String excsubpdt  = JSPUtil.getParameter(request, "excsubpdt"," ");   //하위상품제외여부
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_NIM순이자마진율", basemonth +","+ v_jumcode +","+excsubpdt );
