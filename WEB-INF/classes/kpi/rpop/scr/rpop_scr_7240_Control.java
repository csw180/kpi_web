...
/**
 *  클래스 개요     : 부지점장 대출금 평가내역 조회  <p>
 *  클래스 상세기능 : 부지점장 대출금 평가내역을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2015.03.26<p>
 *  @version 1.0
 *  @author  조형석
 */
public class rpop_scr_7240_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정            
            procName = "UP_KPI_M_S_부지점장대출금평가내역"+ basemonth.substring(0,4);          
