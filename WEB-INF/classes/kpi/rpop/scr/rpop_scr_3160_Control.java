...
/**
 *  클래스 개요    : 신규예수금고객 세부내역 조회  <p>
 *  클래스 상세기능 : 신규예수금고객를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2020.07.22<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_3160_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_신규예수금고객세부내역", basemonth +","+ v_jumcode);
