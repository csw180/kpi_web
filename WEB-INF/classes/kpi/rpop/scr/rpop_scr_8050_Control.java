...
/**
 *  클래스 개요     : 성과증대 프로모션 개인 <p>
 *  클래스 상세기능 : 성과증대 프로모션 개인 데이터를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.03.19<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_8050_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_프로모션개인조회", basemonth+","+period);
