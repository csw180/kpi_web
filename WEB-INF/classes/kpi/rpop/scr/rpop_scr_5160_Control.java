...
/**
 *  클래스 개요     : 소매예수금  평가내역 조회 <p>
 *  클래스 상세기능 : 소매예수금 평가내역을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2017.08.12<p>
 *  @version 1.0
 *  @author  하진영
 */
public class rpop_scr_5160_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            if (baseMon <= 201712) procName = "UP_KPI_M_S_개인예수금내역";
            else  procName = "UP_KPI_M_S_소매예수금내역" + basemonth.substring(0,4);
