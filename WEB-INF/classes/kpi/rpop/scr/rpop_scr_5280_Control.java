...
/**
 *  클래스 개요     :  RM(본부) 대출금 최종실적 조회 <p>
 *  클래스 상세기능 :  RM(본부) 대출금 최종실적 내역을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.10.12<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_5280_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            procName = "UP_KPI_M_S_RM대출금최종실적" + basemonth.substring(0,4);
