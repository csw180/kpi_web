...
/**
 *  클래스 개요    : RM총괄실적 조회  <p>
 *  클래스 상세기능 : RM총괄실적을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2012.03.12<p>
 *  @version 1.0
 *  @author  하진영
 */
public class rpop_scr_7010_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_RM총괄실적", basemonth+","+period+","+pgcode);
