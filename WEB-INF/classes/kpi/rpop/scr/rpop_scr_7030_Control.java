...
/**
 *  클래스 개요     : RM권유계좌확인  <p>
 *  클래스 상세기능 : RM권유계좌확인 을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2012.03.10<p>
 *  @version 1.0
 *  @author  하진영
 */
public class rpop_scr_7030_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String v_jumcode  = JSPUtil.getParameter(request, "v_jumcode","000");
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_RM계좌확인", basemonth+","+ v_jumcode+","+ pygubun);
