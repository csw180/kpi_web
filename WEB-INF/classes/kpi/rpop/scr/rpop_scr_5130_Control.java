...
/**
 *  클래스 개요     : 소매여신 평가내역 조회 <p>
 *  클래스 상세기능 : 소매여신 평가내역을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2014.03.24<p>
 *  @version 1.0
 *  @author  조형석
 */
public class rpop_scr_5130_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            if (baseMon <= 201612) procName = "UP_KPI_M_S_소매여신평가내역";
            else  procName = "UP_KPI_M_S_소매여신평가내역" + basemonth.substring(0,4);
