...
/**
 *  클래스 개요    : 이익추이표 조회  <p>
 *  클래스 상세기능 : 이익추이표를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2006.07.01<p>
 *  @version 1.0
 *  @author  변휘원
 */
public class rpop_scr_1050_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_이익추이표", basemonth +","+ v_jumcode+",1,1,1,1,1,1" );
