...
/**
 *  클래스 개요     : 영업점 일일 대출금 최종실적 조회 
 *  클래스 상세기능 : 영업점 일일 대출금 최종실적 읽어서 JSP에 전달한다. 
 *  작성일 : 2021.10.07 
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_1270_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일대출금경영현안", baseday+","+pgcode+","+sergb+","+metrogb+","+fundgb);
