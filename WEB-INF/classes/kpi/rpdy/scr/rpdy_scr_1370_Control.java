 ...
 *  @author  유용욱
 */
public class rpdy_scr_1370_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일기업저비용성예수금실적", baseday+","+pgcode+","+sergb+","+metrogb);
