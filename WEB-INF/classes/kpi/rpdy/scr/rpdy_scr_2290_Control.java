...
/**
 *  클래스 개요     : 영업점 일일 팀별 관리지표 조회 
 *  클래스 상세기능 : 영업점 일일 팀별 관리지표 내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2020.03.12 
 *  @version 1.0
 *  @author  이해인
 */
public class rpdy_scr_2290_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일업무형부지점장평가실적_개인", baseday+","+pgcode+","+sergb+","+metrogb);
