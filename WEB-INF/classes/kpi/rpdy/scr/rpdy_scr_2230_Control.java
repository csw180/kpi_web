...
/**
 *  클래스 개요     : 영업점 일일 RM 신탁사업 실적 조회
 *  클래스 상세기능 : 영업점 일일 RM 신탁사업 실적 을 읽어서 JSP에 전달한다.
 *  작성일 : 2018.03.19
 *  @version 1.0
 *  @author  양인찬
 */
public class rpdy_scr_2230_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM신탁사업실적", baseday+","+sergb);
