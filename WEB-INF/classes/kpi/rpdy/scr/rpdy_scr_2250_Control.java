...
/**
 *  클래스 개요     : RM(센터) 신규 기업예수금 고객 조회
 *  클래스 상세기능 : RM(센터) 신규 기업예수금 고객을 읽어서 JSP에 전달
 *  작성일 : 2019.03.27
 *  @version 1.0
 *  @author  유용욱
 */
public class rpdy_scr_2250_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM신규기업대출금고객", baseday+","+pgcode+","+sergb+","+metrogb);            
