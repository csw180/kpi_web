...
/**
 *  클래스 개요     : 영업점 카드사업 조회
 *  클래스 상세기능 : 영업점 카드사업 내역 을 읽어서 JSP에 전달한다.
 *  작성일 : 2009.07.15 -2014.03.29(하진영)
 *  @version 1.0
 *  @author  조형석 
 */
public class rpdy_scr_1080_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일카드사업실적", baseday+","+pgcode+","+sergb+","+metrogb);
