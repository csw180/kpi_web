...
/**
 *  클래스 개요     : rm 일일 핵심합산
 *  클래스 상세기능 : rm 일일 핵심합산내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2022.02.10 
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_2430_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM핵심예수금실적", baseday+","+pgcode+","+sergb+","+metrogb+","+kngb);
