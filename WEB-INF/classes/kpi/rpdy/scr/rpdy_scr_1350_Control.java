...
/**
 *  클래스 개요     : 영업점 일일 순수개인예금 평가내역 조회 
 *  클래스 상세기능 : 영업점 일일 순수개인예금 평가내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2016.02.11 
 *  @version 1.0
 *  @author  조형석
 */
public class rpdy_scr_1350_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일개인저비용성예수금실적", baseday+","+pgcode+","+sergb+","+metrogb);
