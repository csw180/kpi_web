 ...
 *  @author  양인찬
 */
public class rpdy_scr_2240_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM신규기업예수금고객", baseday+","+pgcode+","+sergb+","+metrogb);            
