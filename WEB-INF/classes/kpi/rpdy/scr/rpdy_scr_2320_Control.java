...
/**
 *  클래스 개요     : 영업점 rm(본부) 주거래기업실적
 *  클래스 상세기능 : 영업점 rm(본부) 주거래기업실적
 *  작성일 : 2021.02.23
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_2320_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM주거래기업실적", baseday+","+pgcode+","+sergb+","+metrogb);
            ...
            if (!sergb.equals("99")){  /***** 기준일 조회 *****/
                ...
                jado.InputProc("UP_KPI_C_S_WEBLOG"
                              ...
                              +"UP_KPI_D_S_N일일RM주거래기업실적" +","  //프로그램ID
                              +startTime                 +","  //시작시간
                              +endTime                   +","  //완료시간
