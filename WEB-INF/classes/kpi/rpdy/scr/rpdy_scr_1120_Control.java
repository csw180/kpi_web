...
/**
 *  클래스 개요     : 영업점 일일 소매여신 실적 조회 
 *  클래스 상세기능 : 영업점 일일 소매여신 실적내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2014.03.24 
 *  @version 1.0
 *  @author  하진영
 */
public class rpdy_scr_1120_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String fundgb     = JSPUtil.getParameter(request, "fundgb"," ");
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일소매여신운용실적", baseday+","+saupgbn+","+pgcode+","+sergb+","+metrogb+","+fundgb);
