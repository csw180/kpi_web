 ...
 *  @author  변휘원
 */
public class news_scr_1121_Control extends HTMLActionSupport   
{
      /**
...
/****************************변경************************/
        news_scr_1121_EventResponse eventResponse  =    new news_scr_1121_EventResponse(rs,rc,ext);
        request.setAttribute("news_scr_1121_EventResponse", eventResponse);
/****************************변경************************/
