...
public class Role_EventResponse extends EventResponseSupport
{
  DbResultSet menulist;
  String cEvent;
  public Role_EventResponse() {
  }

  public Role_EventResponse(DbResultSet menulist,String cEvent) {
