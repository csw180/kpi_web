...
public class RoleConn_EventResponse extends EventResponseSupport
{
  DbResultSet menulist;
  String cEvent;
  public RoleConn_EventResponse() {
  }

  public RoleConn_EventResponse(DbResultSet menulist,String cEvent) {
