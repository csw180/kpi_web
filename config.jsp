...
/***[SSO CONFIGURATION]**]***********************************************************************/
	...
	private static String serverType = "DEV" ; // DEV, TEST, PROD
	static{
		...
		if ( serverType.equals("DEV") ) {  // 개발환경 
			...
			ASCP_URL = SERVER_URL + ":60060/kpi/login_exec.jsp";
		...
		//	
			...
			//ASCP_URL = SERVER_URL + ":80/sso/login_exec.jsp";
			SERVER_URL = "http://ntpms.suhyup.co.kr" ;
			ASCP_URL = SERVER_URL + ":50060/tpa/login_exec.jsp";
