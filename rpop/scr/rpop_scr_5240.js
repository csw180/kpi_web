...
function setSergb(){
    ...
    if( basemonth >= '201807' && basemonth <= '201812' && pgcode == '16'){
        sergbArr[0] = new Array('2', '신규잔액');
    } else if( basemonth >= '202007' && basemonth <= '202012' && pgcode != '16'){
        sergbArr[0] = new Array('2', '신규잔액');
    } else {
        sergbArr[0] = new Array('2', '순증잔액');
    }
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            ...
            mySheet.DoSearch("rpop.scr.rpop_scr_5240.do?hidden_key=9&basemonth="+basemonth+"&pgcode="+pgcode+"&WideCode="+WideCode+"&sergb="+sergb);
