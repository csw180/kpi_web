<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 기타보고서 - RM(본부) 대출금 최종실적
'프로그램 ID  : rpop_scr_5280.jsp
'프로그램 명  : RM(본부) 대출금 최종실적
'프로그램개요 : RM(본부) 대출금 최종실적
'작   성   자 : 양인찬
'작   성   일 : 2021.10.12
====================================================================
'수정자/수 정 일/수정사유
...
<%
    ...
    String      htm_title        = "RM(본부) 대출금 최종실적";
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_5280.js"></script>
<script>
