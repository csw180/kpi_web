<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : RM(영업점) 총괄 - RM(영업점) 저비용성예수금실적
'프로그램 ID  : rpop_scr_7280.jsp
'프로그램 명  : RM(영업점) 저비용성예수금실적
'프로그램개요 : RM(영업점) 저비용성예수금실적
'작   성   자 : 양인찬
'작   성   일 : 2022.03.07
====================================================================
' 수정자/수정일   : 수정사유
...
<%  
    ...
    String      htm_title        = "RM(영업점) 저비용성예수금실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_7280.js"></script>
