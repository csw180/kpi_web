...
function LoadPage(){
  ...
  // 상위 GRID에 대한 속성정보 설정
   ...
   var msHeaders = [ { Text:"고객구분||당월누적성과|당월누적성과|당월누적성과|전월누적성과|전월누적성과|전월누적성과|증감|증감|증감", Align:"Center"},
                 { Text:"고객구분||고객유지율|유지고객수|전기고객수|고객유지율|유지고객수|전기고객수|고객유지율|유지고객수|전기고객수|", Align:"Center"} ];
   mySheet.InitHeaders(msHeaders, msInfo);

   var msCols = [ {Type:"Text",     Hidden:0,  MinWidth:100,  Align:"Left",    ColMerge:1,   SaveName:"col1" },
             {Type:"Text",      Hidden:1, MinWidth:100,  Align:"Left",    ColMerge:1,   SaveName:"col2" },
   ...
   //지원안함[check again] UnitText="%, 명";
   newSetActionMenu(mySheet,"유지고객실적조회|이탈고객실적조회");
...
//    hiddenGrid  = document.frm.hiddenGrid;
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            ...
            mySheet.DoSearch("rpop.scr.rpop_scr_2040.do?hidden_key=9&basemonth="+basemonth+"&v_jumcode="+v_jumcode);
