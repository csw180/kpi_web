<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 기타보고서 - 기업예수금내역
'프로그램 ID  : rpop_scr_5170.jsp
'프로그램 명  : 기업예수금내역
'프로그램개요 : 기업예수금내역
'작   성   자 : 하진영
'작   성   일 : 2018.03.02
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_5170.js"></script>
<script> 
	...
	function mySheet_OnChangeSum(Row){              
		if (document.frm.basemonth.value >= '201807') 
			mySheet.SetCellValue(mySheet.HeaderRows,26, mySheet.GetCellValue(mySheet.HeaderRows,24) / mySheet.GetCellValue(mySheet.HeaderRows, 25) * 100);
	    else 
	    	mySheet.SetCellValue(mySheet.HeaderRows,27, mySheet.GetCellValue(mySheet.HeaderRows,25) / mySheet.GetCellValue(mySheet.HeaderRows, 26) * 100);     
	}
	*/
