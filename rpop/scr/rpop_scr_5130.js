...
function selectmonth()
{
    ...
    } else if(basemonth >= '201607'){
       document.frm.sergb.disabled = true;
       document.frm.sergb.value = "262";
    } else if(basemonth >= '201407'){
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":             // 조회(상위 GRID)
            mySheet.DoSearch("rpop.scr.rpop_scr_5130.do?hidden_key=9&basemonth="+basemonth+"&pgcode="+pgcode+"&WideCode="+WideCode+"&sergb="+sergb); 
            break;
        case "엑셀내려받기":    // 엑셀내려받기
            inqText       = new Array();
            inqText[0]    = new Array();
...
function initGrid()
{
    ...
    else if(basemonth >= '201501') setGrid2015();
    else if(basemonth >= '201407') setGrid2014Q3();
    else setGrid2014();
}

/*-------------------------------------*/
/* @기능 : 2019년도 3분기 그리드 set  */
/*-------------------------------------*/
function setGrid2019Q3()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
  	...
  	var strHeader1 = 
	   	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                                                                                // 5
	   	+"소계|RM(본부)\n실적|RM(영업점)\n실적|연구위원|고정이하|원리금연체|본부승인이수관|재수관|타지점|단기신규해지|주택금융공사\n양도금액|"                 // 11
	   	+"SH사잇돌|새희망홀씨|햇살론17|SH실버리치연금|청년전월세|신규가계신용|평가제외|기타조정|"                                                              // 8
	   	+"누증실적\n(C)=(A+B)|하반기 신규\n중도금 실적\n(D)|최종누증실적\n(E)=(C+D)|"                                                                          // 3
	   	+"기준실적\n(F)| 순증실적\n(G)=(E-F)|목표\n(H)|달성률\n(I)=(G/H)|"                                                                                     // 4
	   	;
...
function setGrid2019Q2()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	var strHeader1 = 
    	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                                                                                // 5
        +"소계|RM(본부)\n실적|RM(영업점)\n실적|연구위원|고정이하|원리금연체|본부승인이수관|재수관|타지점|단기신규해지|주택금융공사\n양도금액|"                 // 11
        +"SH사잇돌|새희망홀씨|SH실버리치연금|청년전월세|신규가계신용|평가제외|기타조정|"                                                                       // 7
        +"누증실적\n(C)=(A+B)|하반기 신규\n중도금 실적\n(D)|최종누증실적\n(E)=(C+D)|"                                                                          // 3
        +"기준실적\n(F)| 순증실적\n(G)=(E-F)|목표\n(H)|달성률\n(I)=(G/H)|"                                                                                     // 4
        ;
...
/*-------------------------------------*/
/* @기능 : 2019년도 5월 이후 그리드 set  */
/*-------------------------------------*/
function setGrid2019_2()
{
	if(typeof(mySheet) !== "undefined") {
		mySheet.Reset();
	}
  ...
  // 상위 GRID에 대한 속성정보 설정
  	...
  	var strHeader1 = 
	   	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                                                                                // 5
	   	+"소계|RM(센터)\n실적|RM(영업점)\n실적|연구위원|고정이하|원리금연체|본부승인이수관|재수관|타지점|단기신규해지|주택금융공사\n양도금액|"                 // 11
	   	+"SH실버리치|SH사잇돌|새희망홀씨|청년맞춤형|평가제외|기타조정|"                                                                                        // 6
	   	+"누증실적\n(C)=(A+B)|중도금 실적\n(D)|최종누증실적\n(G)=(C+D)|"                                                                                       // 3
	   	+"기준실적\n(F)| 순증실적\n(G)=(E-F)|목표\n(H)|달성률\n(I)=(G/H)|"                                                                                     // 4
	   	;
...
function setGrid2019()
{
	...
	var strHeader1 = 
    	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                                                                                // 5
        +"소계|RM(센터)\n실적|RM(영업점)\n실적|연구위원|고정이하|원리금연체|본부승인이수관|재수관|타지점|단기신규해지|주택금융공사\n양도금액|"                 // 11
        +"SH실버리치|SH사잇돌|새희망홀씨|평가제외|기타조정|"                                                                                                   // 5
        +"누증실적\n(C)=(A+B)|중도금 실적\n(D)|최종누증실적\n(G)=(C+D)|"                                                                                       // 3
        +"기준실적\n(F)| 순증실적\n(G)=(E-F)|목표\n(H)|달성률\n(I)=(G/H)|"                                                                                     // 4
        ;
...
function setGrid2017Q3()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	var strHeader1 = 
	    "점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
	    +"소계|RM실적|연구위원 등|해양투자금융|고정이하|원리금연체|구조조정여신|본부승인이수관|타지점 등|신바람|새희망홀씨|단기신규해지|"                // 12
	    +"보증서담보|MY편의점|수산해양일반|SH올라잇신용|SH사잇돌중금리|SH파트너신용|SH프라임신용|SH전세보증|SH해우리|SH파워전세|재수관|부지점장권유여신|기타조정|"  // 13
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|실적\n(E)=(C-D)|목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;
    ...
    cols.push({Type:"AutoSum",   Hidden:0, MinWidth:120,  Align:"Right",   ColMerge:1,   SaveName:"",  CalcLogic:"",   Format:"Integer",     PointCount:0,   DecimalAdjust:1, UpdateEdit:0,   InsertEdit:0,   EditLen:18 });
    cols.push({Type:"AutoSum",   Hidden:0, MinWidth:120,  Align:"Right",   ColMerge:1,   SaveName:"",  CalcLogic:"",   Format:"Integer",     PointCount:0,   DecimalAdjust:1, UpdateEdit:0,   InsertEdit:0,   EditLen:18 });
    cols.push({Type:"Float",     Hidden:0,  MinWidth:120,  Align:"Right",   ColMerge:1,   SaveName:"",  CalcLogic:"",   Format:"NullFloat",   PointCount:1,   UpdateEdit:0,   InsertEdit:0,   EditLen:18 });
...
function setGrid2017()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	var strHeader1 = 
	    ...
	    +"새희망홀씨|단기신규해지|보증서담보|MY편의점|수산해양일반|SH올라잇신용|SH사잇돌중금리|재수관|부지점장권유여신|기타조정|"   // 10
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|실적\n(E)=(C-D)|목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;
...
function setGrid2015Q3()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	var strHeader0 = 
	   	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
	    +"조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|" // 16
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;

  	var strHeader1 = 
	    "점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
	    +"소계|RM실적|연구위원 등|해양투자금융|고정이하|원리금연체|구조조정여신|본부승인이수관|타지점 등|신바람|새희망홀씨|단기신규해지|보증서담보|재수관|부지점장권유여신|기타실적차감|"  // 14
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;
...
function setGrid2015()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	basemonth = document.frm.basemonth.value;
   	...
   	var strHeader0 = 
	   	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
	    +"조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|조정내역(B)|" // 14
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;

   	var strHeader1 = 
	    "점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
	    +"소계|RM실적|연구위원 등|해양투자금융|고정이하|원리금연체|구조조정여신|본부승인이수관|타지점 등|신바람|새희망홀씨|단기신규해지|부지점장권유여신|기타실적차감|"  // 14
	    +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
	    ;
...
function setGrid2014Q3()
{
	if(typeof(mySheet) !== "undefined") {
  	...
  	var strHeader1 = 
    	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
        +"소계|RM실적|연구위원 등|해양투자금융|고정이하|원리금연체|구조조정여신|본부승인이수관|타지점 등|단기신규해지|부지점장권유여신|신상품가중치|기타실적차감|"  // 13
        +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
        ;
...
function setGrid2014()
{
	...
	var strHeader0 = 
  	...
  	var strHeader1 =
    	"점번호|점명|PG명|총금액|총금액\n(월중평잔적용)\n(A)|"                                     // 5
        +"소계|RM실적|연구위원 등|해양투자금융|고정이하|원리금연체|구조조정여신|본부승인이수관|타지점 등|단기신규해지|기타실적차감|"  // 11
        +"누증실적\n(C)=(A+B)|기준실적\n(D)|순증실적\n(E)=(C-D)|순증목표\n(F)|달성률\n(G)=(E/F)|"   // 5
        ;
