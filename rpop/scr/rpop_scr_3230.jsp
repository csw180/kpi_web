...
'프로그램 ID  : rpop_scr_3230.jsp
'프로그램 명  : 고객수증대 세부내역
'프로그램개요 : 고객수증대 세부내역 조회
'작   성   자 : 양인찬
'작   성   일 : 2022.03.14
====================================================================
'수정자/수정일: 
...
<%  
    ...
    String      leftmenu_name    = "세무내역 보고서"; 
    String      htm_title        = "고객수증대 세부내역"; 
    String      actionname       = "";
    String      strErrMsg        = "";
    String      status           = "0";
    String      allRole          = "0";
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_3230.js"></script>
<script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  ...
  <tr>
    ...
    <td colspan="4" class="nobor end"><select name="searchCode" class="select" onchange="allDelDataGrid(mySheet);showUnitText('원, %');" >
