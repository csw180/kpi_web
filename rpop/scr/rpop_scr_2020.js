...
function LoadPage() {
  ...
  // 상위 GRID에 대한 속성정보 설정
    mySheet.SetConfig( { SearchMode:2, MergeSheet:5, Page:20, FrozenCol:1 } );
   	...
   	var msHeaders = [ { Text:"구분|당월누적성과|당월누적성과|당월누적성과|전월누적성과|전월누적성과|전월누적성과|전기누적성과|전기누적성과|전기누적성과|증감|증감|증감|증감", Align:"Center"},
                 { Text:"구분|마진율|평잔|순이자수익|마진율|평잔|순이자수익|마진율|평잔|순이자수익|마진율|증가율|평잔|순이자수익", Align:"Center"} ];
   	mySheet.InitHeaders(msHeaders, msInfo);

   	var msCols = [ {Type:"Text",     Hidden:0,  MinWidth:160,  Align:"Left",    ColMerge:1,   SaveName:"col1" },
             ...
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   ColMerge:1,   SaveName:"",      CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:18 },
             {Type:"Float",     Hidden:0,  MinWidth:80,   Align:"Right",   ColMerge:1,   SaveName:"",      CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:18 },
             {Type:"Float",     Hidden:0,  MinWidth:130,  Align:"Right",   ColMerge:1,   SaveName:"",      CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:18 },
...
//    hiddenGrid  = document.frm.hiddenGrid;
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            if (basemonth >= '200901') {
               alert("2008년도 자료까지 조회가능합니다.");
               return;
            }
            mySheet.DoSearch("rpop.scr.rpop_scr_2020.do?hidden_key=9&basemonth="+basemonth+"&v_jumcode="+v_jumcode+"&bgubun="+bgubun+"&mgubun="+mgubun);
