...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서
'프로그램 ID  : rpop_scr_3210.jsp
'프로그램 명  : 디지털신규비이자고객 세부내역
'프로그램개요 : 디지털신규비이자고객 세부내역 조회
'작   성   자 : 양인찬
'작   성   일 : 2021.08.24
====================================================================
'수정자/수정일: 
...
<%  
    ...
    String      leftmenu_name    = "세부내역 보고서"; 
    String      htm_title        = "디지털신규비이자고객 세부내역"; 
    String      actionname       = "";
    String      strErrMsg        = "";
    String      status           = "0";
    String      allRole          = "0";
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_3210.js"></script>
<script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  ...
  <tr>
    ...
    <td colspan="4" class="nobor end"><select name="searchCode" class="select" onchange="allDelDataGrid(mySheet); showUnitText('원, Point');" >
