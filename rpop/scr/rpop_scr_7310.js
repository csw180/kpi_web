...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":             // 조회(상위 GRID)
            mySheet.DoSearch("rpop.scr.rpop_scr_7310.do?hidden_key=9&basemonth="+basemonth+"&cifgb="+cifgb+"&sergb="+sergb); 
...
function setGrid2022H1()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
    var strHeader0 = "점번호|점명|RM(영업점)|RM(영업점)|PG명|"                                                          // 5
      +"개인핵심\n순증실적\n3배\n(A)|기업핵심\n순증실적\n(B)|"
      +"펌뱅킹\n월중평잔 실적\n(C)|펌뱅킹\n기준실적\n(D)|펌뱅킹\n순증실적\n(E)=(C-D)|"
      +"경리나라\n월중평잔 실적\n(F)|경리나라\n기준실적\n(G)|경리나라\n순증실적\n(H)=(F-G)|"
      +"CMS\n월중평잔 실적\n(I)|CMS\n기준실적\n(J)|CMS\n순증실적\n(K)=(I-J)|"
	...
	var strHeader1 = "점번호|점명|직원번호|성명|PG명|"                                                                  // 5
      +"개인핵심\n순증실적\n3배\n(A)|기업핵심\n순증실적\n(B)|"
      +"펌뱅킹\n월중평잔 실적\n(C)|펌뱅킹\n기준실적\n(D)|펌뱅킹\n순증실적\n(E)=(C-D)|"
      +"경리나라\n월중평잔 실적\n(F)|경리나라\n기준실적\n(G)|경리나라\n순증실적\n(H)=(F-G)|"
      +"CMS\n월중평잔 실적\n(I)|CMS\n기준실적\n(J)|CMS\n순증실적\n(K)=(I-J)|"
