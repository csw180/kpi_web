...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":         // 조회(상위 GRID)
            ...
            break;
        case "조회":             // 조회(상위 GRID)
            mySheet.DoSearch("rpop.scr.rpop_scr_4060.do?hidden_key=9&basemonth="+basemonth+"&pgcode="+pgcode+"&period="+4); 
            break;
        case "엑셀내려받기":    // 엑셀내려받기
            inqText       = new Array();
            inqText[0]    = new Array();
...
function setGrid2020H2()
{
	...
	var strHeader1 =
        ...
        +"최종실적|영업점 KPI실적|소관업무 합산|"
        +"상품판매|상품판매|상품판매|상품판매|"
        +"개인 신규 예수금 고객|개인 신규 예수금 고객|개인 신규 예수금 고객|개인 신규 예수금 고객|"
        +"개인예수금(합산)|"
        +"개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|"
        +"개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|"
        +"기업예수금(합산)|"
...
function setGrid2019Q3()
{
	...
	var strHeader0 = 
        ...
        +"소매대출금|소매대출금|소매대출금|소매대출금|소매대출금|"                                                     //5
        +"개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|"                     //3
        +"개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|"                                                  //2
        +"개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|"                     //3
        +"개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|"                                                  //2
        +"신규예금고객(개인)|신규예금고객(개인)|신규예금고객(개인)|신규예금고객(개인)|신규예금고객(개인)|"             //5
        +"전략사업|전략사업|"                                                                                          //2
        +"전략사업(개인신규저비용성)\n(평가)|전략사업(개인신규저비용성)\n(평가)|전략사업(개인신규저비용성)\n(평가)|"   //3
        +"전략사업(개인신규저비용성)\n(평가)|전략사업(개인신규저비용성)\n(평가)|"                                      //2
        +"전략사업(소매대출)|전략사업(소매대출)|전략사업(소매대출)|전략사업(소매대출)|전략사업(소매대출)|"             //5
