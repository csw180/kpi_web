<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 개인PI - 우수직원실적평가
'프로그램 ID  : rpop_scr_5070.jsp
'프로그램 명  : 우수직원실적평가
'프로그램개요 : 우수직원실적평가
'작   성   자 : 박아란
'작   성   일 : 2014.04.21
====================================================================
'수정자/수정일/수정사유: 하진영/20150624/2015년1월~ 예수금이익 개인 & 기타로 분리
===============================================================--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ include file="/module/jsp_header.inc"%>
<%  
    String topmenu_name  = "개인PI";
    String leftmenu_name = "우수직원실적평가"; 
    String htm_title     = "우수직원실적평가"; 
    String actionname    = "";
    String jumcode       = "";
    String jumname       = "";
    String strErrMsg     = "";
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_5070.js"></script>
<script> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="pdLR mgT5">
    <tr>
        <td>
            <marquee scrollamount='3' direction='left' width='700'> 우수직원 실적평가는 당해년도 이익만 해당합니다.</marquee>
        </td>
    </tr>
</table>         		  
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="pdLR mgT5">
