...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":         // 조회(상위 GRID)
            ...
            break;
        case "조회":             // 조회(상위 GRID)
            mySheet.DoSearch("rpop.scr.rpop_scr_4080.do?hidden_key=9&basemonth="+basemonth+"&pgcode="+pgcode+"&period="+4);
            break;
        case "엑셀내려받기":    // 엑셀내려받기
            inqText       = new Array();
            inqText[0]    = new Array();
...
function setGrid2022H1()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	var strHeader1 = "점번호|점명|부지점장|PG명|팀구분|순위|"
   		...
   		+"상품판매|상품판매|상품판매|상품판매|"
   		+"개인마케팅(합산)|"
   		+"개인마케팅_급여성입금|개인마케팅_급여성입금|개인마케팅_급여성입금|개인마케팅_급여성입금|"
   		+"개인마케팅_결제성출금|개인마케팅_결제성출금|개인마케팅_결제성출금|개인마케팅_결제성출금|"
   		+"신규예수금고객(개인)|신규예수금고객(개인)|신규예수금고객(개인)|신규예수금고객(개인)|"
   		+"개인예수금(합산)|"
...
function setGrid2021H2()
{
	...
	var strHeader0 =
        ...
        +"최종실적|종합성과|소관업무 합산|업무형 부지점장\n개인실적 합산|"                                                 //4
        +"고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|"                      //10
        +"고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|"                                                 //7
	...
	var strHeader1 =
        ...
        +"상품판매|상품판매|상품판매|상품판매|"
        +"개인마케팅(합산)|"
        +"개인마케팅(건수)|개인마케팅(건수)|개인마케팅(건수)|개인마케팅(건수)|"
        +"개인마케팅(평잔)|개인마케팅(평잔)|개인마케팅(평잔)|개인마케팅(평잔)|"
        +"신규예수금고객|신규예수금고객|신규예수금고객|신규예수금고객|"
        +"개인예수금(합산)|"
        +"개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|"
        +"개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|"
        +"개인저비용성예수금(합산)|"
        ...
        +"공제사업(신계약적립식)|공제사업(신계약적립식)|공제사업(신계약적립식)|공제사업(신계약적립식)|"
        +"공제사업(신계약일시납)|공제사업(신계약일시납)|공제사업(신계약일시납)|공제사업(신계약일시납)|"
        +"공제사업(신계약보장성)|공제사업(신계약보장성)|공제사업(신계약보장성)|공제사업(신계약보장성)|"
...
function setGrid2021H1()
{
	...
	var strHeader1 =
        ...
        +"상품판매|상품판매|상품판매|상품판매|"
        +"점주마케팅(합산)|"
        +"점주마케팅(건수)|점주마케팅(건수)|점주마케팅(건수)|점주마케팅(건수)|"
        +"점주마케팅(평잔)|점주마케팅(평잔)|점주마케팅(평잔)|점주마케팅(평잔)|"
        +"디지털고객(합산)|"
        +"디지털고객(스마트가입수)|디지털고객(스마트가입수)|디지털고객(스마트가입수)|디지털고객(스마트가입수)|"
        ...
        +"외환사업|외환사업|외환사업|외환사업|펀드사업|펀드사업|펀드사업|펀드사업|"
        +"공제사업(이익)|공제사업(이익)|공제사업(이익)|공제사업(이익)|"
        +"공제사업(신계약적립식)|공제사업(신계약적립식)|공제사업(신계약적립식)|공제사업(신계약적립식)|"
        +"공제사업(신계약일시납)|공제사업(신계약일시납)|공제사업(신계약일시납)|공제사업(신계약일시납)|"
        +"신탁사업|신탁사업|신탁사업|신탁사업|"
...
function setGrid2020Q3()
{
	...
	var strHeader0 =
        ...
        +"최종실적|영업점 KPI실적|소관업무 합산|업무형 부지점장\n개인실적 합산|"                                           //4
        +"고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|고객관계|"                                        //8
        +"성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|"       //15
        +"성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|성장성|"//16
        +"비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|"                                   //11
        +"비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|"                                   //11
        +"비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|비이자|"                                   //11
        +"비이자|비이자|비이자|비이자|"                                                                                    //4
	...
	var strHeader1 =
        ...
        +"개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|개인저비용성예수금(반기평잔)|"
        +"개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|개인저비용성예수금(월중평잔)|"
        +"개인대출금(신규잔액)|개인대출금(신규잔액)|개인대출금(신규잔액)|개인대출금(신규잔액)|"
        +"공제/펀드/카드|"
        ...
        +"외환사업|외환사업|외환사업|외환사업|신탁사업|신탁사업|신탁사업|신탁사업|"
        +"가계여신신규금액|가계여신신규금액|가계여신신규금액|가계여신신규금액|"
        +"비이자이익|비이자이익|비이자이익|비이자이익|"
        ;
