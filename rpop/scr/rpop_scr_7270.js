	...
	{ 
		...
		if (chst =='0' || chst == 'R' || chst == '1')  
		{
        	for(var i=1; i < ln; i++) {
		 	...
		 	alert("점번호는 0~, 1~ 및 R~ 만 가능합니다. 점번호를 확인하세요" );
	}
}
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            ...
            mySheet.DoSearch("rpop.scr.rpop_scr_7270.do?hidden_key=9&basemonth="+basemonth+"&v_jumcode="+v_jumcode+"&custgubun="+custgubun+"&searchCode="+searchCode+"&pg_url="+pg_url);
            break;
