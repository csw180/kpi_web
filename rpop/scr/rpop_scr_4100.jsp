...
'프로그램 ID  : rpop_scr_4100.jsp
'프로그램 명  : 기업업무형 부지점장 B KPI
'프로그램개요 : 기업업무형 부지점장 B KPI
'작   성   자 : 양인찬
'작   성   일 : 2021.03.19
====================================================================
'수정자/수정일 :
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_4100.js"></script>
<script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <td colspan="3"><select name="pgcode" onchange="initGrid();"><option value="0">전체</option></select></td>
  ...
  <tr style="display:none;"> 	
    ...
    <td class="nobor end" colspan="7"> 
    	<input type="checkbox" name="subChk" checked disabled="true" ><!-- onclick="javascript:selectsubchk();" -->
    </td>
  </tr>
</table>
