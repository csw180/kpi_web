<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 기타보고서 - 개인예수금내역
'프로그램 ID  : rpop_scr_5160.jsp
'프로그램 명  : 개인예수금내역
'프로그램개요 : 개인예수금내역
'작   성   자 : 하진영
'작   성   일 : 2017.08.12
...
<script language="javascript" src="/kpi/rpop/scr/rpop_scr_5160.js"></script>
<script> 
	...
	function mySheet_OnChangeSum(Row){
	    if (document.frm.basemonth.value >= '201807') CellValue2(Row,27) = CellValue(Row,25) / CellValue(Row, 26) * 100 ;     
	    else if (document.frm.basemonth.value >= '201801') CellValue2(Row,26) = CellValue(Row,24) / CellValue(Row, 25) * 100 ;     
	    else CellValue2(Row,21) = CellValue(Row,19) / CellValue(Row, 20) * 100 ;   //2017년 하반기
