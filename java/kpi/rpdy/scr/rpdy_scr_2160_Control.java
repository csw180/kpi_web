...
/**
 *  클래스 개요     : RM 일일예대율 평가 조회
 *  클래스 상세기능 : RM 일일예대율 평가를 읽어서 JSP에 전달한다.
 *  작성일 : 2017.03.08 
 *  @version 1.0
 *  @author  조형석
 */
public class rpdy_scr_2160_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM예대율현황", baseday+","+sergb);
