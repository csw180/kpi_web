...
/**
 *  클래스 개요     : 영업점 일일 디지털고객 신규비이자고객 실적
 *  클래스 상세기능 : 영업점 일일 디지털고객 신규비이자고객 실적을 읽어서 JSP에 전달한다. 
 *  작성일 : 2021.02.19
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_1100_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일디지털판매비이자고객실적", baseday+","+sergb+","+pgcode+","+metrogb);
