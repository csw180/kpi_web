 ...
 *  클래스 상세기능 : 영업점 일일 경영현안 실적 내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2021.10.07 
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_2390_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM경영현안", baseday+","+sergb);
