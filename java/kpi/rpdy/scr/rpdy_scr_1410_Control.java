...
/**
 *  클래스 개요     : 영업점 일일 신규우량고객
 *  클래스 상세기능 : 영업점 일일 신규우량고객 내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2021.08.09
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_1410_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일신규우량고객", baseday+","+pgcode+","+sergb+","+metrogb); // 2021년 일일주거래신규우량고객실적
