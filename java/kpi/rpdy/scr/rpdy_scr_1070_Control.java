...
/**
 *  클래스 개요     : 영업점 공제사업 조회
 *  클래스 상세기능 : 영업점 공제사업내역을 읽어서 JSP에 전달한다.
 *  작성일 : 2014.03.29 
 *  @version 1.0
 *  @author  하진영
 */
public class rpdy_scr_1070_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일공제사업실적", baseday+","+pgcode+","+sergb+","+metrogb);
