...
/**
 *  클래스 개요     : 영업점 일일 기업저비용성예수금 평가내역 조회 
 *  클래스 상세기능 : 영업점 일일 기업저비용성예수금 평가내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2022.01.24 
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_1440_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String kngb       = JSPUtil.getParameter(request, "kngb"," ");
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일핵심예수금실적", baseday+","+pgcode+","+sergb+","+metrogb+","+kngb);
