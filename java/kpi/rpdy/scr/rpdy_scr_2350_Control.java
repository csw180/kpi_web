...
/**
 *  클래스 개요     : 성과증대 일일프로모션영업점
 *  클래스 상세기능 : 성과증대 일일프로모션영업점
 *  작성일 : 2021.03.18
 *  @version 1.0
 *  @author  이상용
 */
public class rpdy_scr_2350_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일성과증대프로모션", baseday+","+sergb+","+pgcode+","+metrogb);
