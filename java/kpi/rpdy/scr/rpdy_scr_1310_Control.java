...
/**
 *  클래스 개요     : 영업점 일일 기업여신 운용실적 조회 
 *  클래스 상세기능 : 영업점 일일 기업여신 운용실적 읽어서 JSP에 전달한다. 
 *  작성일 : 2018.02.03
 *  @version 1.0
 *  @author  유용욱
 */
public class rpdy_scr_1310_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일기업여신운용실적", baseday+","+saupgbn+","+pgcode+","+sergb+","+metrogb);
