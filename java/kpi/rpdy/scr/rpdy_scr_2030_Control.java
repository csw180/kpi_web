...
/**
 *  클래스 개요     : 영업점 일일 총여신 운용실적 조회 
 *  클래스 상세기능 : 영업점 일일 총여신 운용실적 읽어서 JSP에 전달한다. 
 *  작성일 : 2013.03.07 
 *  @version 1.0
 *  @author  조형석
 */
public class rpdy_scr_2030_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String fundgb     = JSPUtil.getParameter(request, "fundgb","0");
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일총여신운용실적", baseday+","+saupgbn+","+pgcode+","+sergb+","+metrogb+","+fundgb);
