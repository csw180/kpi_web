...
/**
 *  클래스 개요     : 영업점 일일 RM대출금 조회 
 *  클래스 상세기능 : 영업점 일일 RM대출금 내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2013.03.13 
 *  @version 1.0
 *  @author  조형석
 */
public class rpdy_scr_2100_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일RM대출금실적", baseday+","+sergb);
