...
/**
 *  클래스 개요     : 영업점 일일 펀드사업 신규고객수 세부내역 조회 
 *  클래스 상세기능 : 영업점 일일 펀드사업 신규고객수 세부내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2022.08.17 
 *  @version 1.0
 *  @author  이해인
 */
public class rpdy_scr_1041_Control extends HTMLActionSupport   
{
    /*
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일신규우량고객세부내역", baseday+","+jumcode+","+sergb);
