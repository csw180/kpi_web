...
/**
 *  클래스 개요     : 영업점 일일 상품판매실적세부내역 조회 
 *  클래스 상세기능 : 영업점 일일 상품판매실적세부내역내역을 읽어서 JSP에 전달한다. 
 *  작성일 : 2020.07.20 
 *  @version 1.0
 *  @author  유용욱
 */
public class rpdy_scr_1391_Control extends HTMLActionSupport   
{
    /*
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_D_S_N일일상품판매실적세부내역", baseday+","+jumcode+","+sergb);
