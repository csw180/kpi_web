...
/**
 *  클래스 개요     : 성과증대 프로모션 영업점 <p>
 *  클래스 상세기능 : 성과증대 프로모션 영업점 데이터를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.03.19<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_8040_Control extends HTMLActionSupport   
{
      /**
       * HttpRequst의 정보를 데이터 모델로 파싱하여 반환한다.
       */
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_프로모션영업점조회", basemonth+","+period);
