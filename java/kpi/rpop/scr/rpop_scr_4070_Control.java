...
/**
 *  클래스 개요    : 기업금융팀 KPI 총괄실적 조회  <p>
 *  클래스 상세기능 : 기업금융팀 KPI 총괄실적을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2019.11.07<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_4070_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            procName = "UP_KPI_M_S_기업금융팀kpi총괄실적" + basemonth.substring(0,4);
