...
/**
 *  클래스 개요    : 개인별PI실적 조회  <p>
 *  클래스 상세기능 : 개인별PI실적보고서를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2008.01.29<p>
 *  @version 1.0
 *  @author  조형석
 */
public class rpop_scr_5010_Control extends HTMLActionSupport   
{
      /**
       * HttpRequst의 정보를 개인별PI실적  데이타모델로 파싱하여 반환한다.
       */
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_개인별PI실적", basemonth+","+jumcode);
