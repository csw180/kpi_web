...
/**
 *  클래스 개요    : 부지점장 가중평균 연체비율 조회  <p>
 *  클래스 상세기능 : 부지점장 가중평균 연체비율을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.08.17<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_7260_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            procName = "UP_KPI_M_S_부지점장가중평균연체비율" + basemonth.substring(0,4);
