...
/**
 *  클래스 개요    : 비이자수익 조회  <p>
 *  클래스 상세기능 : 비이자수익을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2006.07.01<p>
 *  @version 1.0
 *  @author  변휘원
 */
public class rpop_scr_2080_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_비이자수익", basemonth +","+ v_jumcode +","+ pygubun);
