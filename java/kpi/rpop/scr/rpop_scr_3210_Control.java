...
/*
 *  클래스 개요    : 디지털신규비이자고객 세부내역 조회  <p>
 *  클래스 상세기능 : 디지털신규비이자고객 세부내역을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.08.24<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_3210_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_디지털고객세부내역", basemonth +","+ v_jumcode);
