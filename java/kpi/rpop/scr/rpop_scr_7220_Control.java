...
/**
 *  클래스 개요     : 부지점장총괄실적 조회  <p>
 *  클래스 상세기능 : 부지점장총괄실적을 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2014.07.17<p>
 *  @version 1.0
 *  @author  조형석
 */
public class rpop_scr_7220_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_부지점장총괄실적", basemonth+","+period);
