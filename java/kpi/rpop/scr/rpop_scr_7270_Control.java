...
/**
 *  클래스 개요    : 부지점장 연체고객별 보고서 조회  <p>
 *  클래스 상세기능 : 부지점장 연체고객별 보고서를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2021.08.17<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_7270_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_부지점장연체고객별보고서", basemonth +","+ v_jumcode+","+custgubun);
            ...
            jado.InputProc("UP_KPI_C_S_WEBLOGN"
                          ,"2"                       +","  //2:rpop,1:rpdy
                          +"UP_KPI_M_S_부지점장연체고객별보고서"   +","  //프로그램ID
                          +startTime                 +","  //시작시간
                          +endTime                   +","  //완료시간
