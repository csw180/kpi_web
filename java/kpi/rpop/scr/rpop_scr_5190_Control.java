...
/**
 *  클래스 개요     : 금융본부 저비용성예수금 평가내역 조회 <p>
 *  클래스 상세기능 : 금융본부 저비용성예수금 평가내역을 읽어서 JSP에 전달한다.<p>
 *                    19년 하반기 저비용성 => 기업저비용성 분리로, 금융본부 실적 산출 시 같은 프로시져 사용
 *  작성일 : 2019.03.21<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_5190_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            //프로시져명 설정
            procName = "UP_KPI_M_S_저비용성예수금내역" + basemonth.substring(0,4);
