...
/**
 *  클래스 개요    : 상품판매 세부내역 조회  <p>
 *  클래스 상세기능 : 상품판매를 읽어서 JSP에 전달한다.<p>
 *  작성일 : 2020.07.22<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_3170_Control extends HTMLActionSupport   
{
      /**
       * HttpRequst의 정보를 데이타모델로 파싱하여 반환
       */
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        String sergb      = JSPUtil.getParameter(request, "sergb"," ");        //조회구분코드
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_상품판매세부내역", basemonth +","+ v_jumcode +","+ sergb);
