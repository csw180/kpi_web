...
/**
 *  클래스 개요     : 고객수익률 실적 조회  <p>
 *  클래스 상세기능 : 고객수익률 실적<p>
 *  작성일 : 2020.08.13<p>
 *  @version 1.0
 *  @author  양인찬
 */
public class rpop_scr_5470_Control extends HTMLActionSupport   
{
      /**
    ...
    public EventResponse perform(HttpServletRequest request) throws HTMLActionException {
        ...
        try
        {
            ...
            rs = jado.callProc("UP_KPI_M_S_고객수익률실적조회", basemonth +","+pgcode);
