...
/**
 *  클래스 개요    : 첨부파일-Dispatch <p>
 *  클래스 상세기능 : HTTP parser<p>
 *  작성일 : 2006.06.20<p>
 *  @version 1.0
 *  @author  변휘원
 */
public class news_scr_1113_Control extends HTMLActionSupport   
{
      /**
...
/****************************변경************************/
             rs = jado.callProc("UP_KPI_S_S_NEWS첨부파일", kongigb + "," + wt_date+ "," + wt_time);
/****************************변경************************/
...
/****************************변경************************/
        news_scr_1113_EventResponse eventResponse  =    new news_scr_1113_EventResponse(rs,rc,ext);
        request.setAttribute("news_scr_1113_EventResponse", eventResponse);
/****************************변경************************/
