 ...
 *  @author  변휘원
 */
public class news_scr_1122_Control extends HTMLActionSupport   
{
      /**
...
/****************************변경************************/
             rs = jado.callProc("UP_KPI_S_S_NEWS게시판내용", kongigb + "," + wt_date+ "," + wt_time);
/****************************변경************************/
...
/****************************변경************************/
        news_scr_1122_EventResponse eventResponse  =    new news_scr_1122_EventResponse(rs,rc,ext);
        request.setAttribute("news_scr_1122_EventResponse", eventResponse);
/****************************변경************************/
