...
function LoadPage(){
	...
	createIBSheet2(  document.getElementById("sheetObj"),"mySheet", "230px", "400px");
   	...
   	var cols = [ {Type:"Text",      Hidden:0,  Width:50,   Align:"Center",  SaveName:"",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             {Type:"Text",      Hidden:0,  Width:150,  Align:"Left",    SaveName:"",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 } ];
...
<table width="100%">  
  <tr>
    <td height="30" background="img/pop_cbg.gif" border="0" cellspacing="0" cellpadding="0" align="center" valign="bottom"><!--  background="img/pop_cbg.gif"  -->
      <img src="img/sky/butt_choice.gif" onclick="opener_ins()" border="0" style="cursor:hand">&nbsp;
      <img src="img/sky/butt_close.gif"  onclick="self.close()" border="0" style="cursor:hand">&nbsp;
    </td>
  </tr>
</table>
