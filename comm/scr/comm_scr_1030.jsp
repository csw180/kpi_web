...
function LoadPage(){
	...
	createIBSheet2(  document.getElementById("sheetObj"),"mySheet", "280px", "300px");
 	...
 	//지원안함[check again] if (location.hostname != "") InitHostInfo(location.hostname, location.port, page_path);
   	...
   	var cols = [ {Type:"Text",      Hidden:0,  MinWidth:80,   Align:"Center",  SaveName:"",               CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             {Type:"Text",      Hidden:0,  MinWidth:200,  Align:"Left",    SaveName:"v_accountname",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 } ];
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  ...
  <tr>
    ...
    <td class="al_R end">
      <span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:search_name();">조회</span>
    </td>
  </tr>
</table>
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="pdLR mgT5">
  <tr> 
  ...
  <tr>
    <td class="al_C pdT5" align="center">
