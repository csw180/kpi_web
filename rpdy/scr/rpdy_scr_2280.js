...
function selectsubchk()
{
	...
	if (baseday >= '20220101') {    	   	      
	    ...
	    if (subChk) { 								// 세부내역 체크 전
			/* -------- 영업점 기준 -------- */			// 세부내역 체크 전_영업점 (기업금융KPI) 3367 (1)
	    	// 상품판매
	    	...
	    	// 공제사업(신계약적립_조회)
	    	//mySheet.ColHidden(46)  = false;   
	    	//mySheet.ColHidden(47)  = false;
	    	//mySheet.ColHidden(48)  = false;
	    	//mySheet.ColHidden(49)  = false;
	    	// 공제사업(신계약일시납)
	    	...
	    	mySheet.SetColHidden(80,0);
	 		...
	 		/* -------- 영업점 기준 -------- */			// 세부내역 체크 후_영업점 (기업금융KPI) 3367 (2)
	    	// 상품판매
	    	...
	    	//mySheet.ColHidden(47)  = true;
	    	//mySheet.ColHidden(48)  = true;
	    	//mySheet.ColHidden(49)  = true;
	    	// 공제사업(신계약일시납)
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준일":           // 조회(상위 GRID)
            ...
            if(isRoleEnable == '1') {
            	 // 전산정보부 및 성과 담당자
               hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2280.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98" );
            } else {
               hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2280.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
            }*/
            break;
        case "조회":             // 조회(상위 GRID)
           ...
           //   }	
           // }          
            mySheet.DoSearch("rpdy.scr.rpdy_scr_2280.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&metrogb="+metrogb);
...
/*
    if      (baseday <= '20190630') setGrid2019();
...
function setGrid2021H()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	strHeader0 = 
	  ...
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|" 
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|"
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|"
	  ;    
	...
	strHeader2 = 
	  ...
	  +"목표|실적|달성률|평점/배점|"		            	  // 4 기업저비용성예수금(반기평잔)
	  +"목표|실적|달성률|평점/배점|"        			      // 4 기업저비용성예수금(월중평잔)
	  +"밴드범위|실적|밴드범위이탈금액| 평점/배점|"      // 4 대출금(순증잔액)	 
...
function setGrid2021()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	strHeader0 =  
	  ...
	  "점번호|점명|PG명|팀구분\n(개인/기업)|순위|소관업무 합산실적|"
	  //고객관계 8
	  +"고 객 관 계|고 객 관 계|고 객 관 계|고 객 관 계|고 객 관 계|고 객 관 계|고 객 관 계|고 객 관 계|"
	  //성장성 31
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|" 
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|"
	  +"성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|성  장  성|"
	...
	strHeader1 = 
	  ...
	  "점번호|점명|PG명|팀구분\n(개인/기업)|순위|소관업무 합산실적|"
	  //고객관계 8
	  +"신규예금고객(기업)|신규예금고객(기업)|신규예금고객(기업)|신규예금고객(기업)|신규대출 고객|신규대출 고객|신규대출 고객|신규대출 고객|"          
	  //성장성 31
	  +"기업예수금(합산)|" 
	  +"기업예수금(반기평잔)|기업예수금(반기평잔)|기업예수금(반기평잔)|기업예수금(반기평잔)|"                               
	  +"기업예수금(순증잔액)|기업예수금(순증잔액)|기업예수금(순증잔액)|기업예수금(순증잔액)|"  
...
function setGrid2020H2()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	strHeader1 = 
	  ...
	  +"기업 신규 예수금 고객|기업 신규 예수금 고객|기업 신규 예수금 고객|기업 신규 예수금 고객|기업 신규 예수금 고객|"          
	  //성장성 35
	  +"기업예수금(합산)|기업예수금(합산)|"                                     
	  +"기업예수금(반기평잔)|기업예수금(반기평잔)|기업예수금(반기평잔)|기업예수금(반기평잔)|"  
	  +"기업예수금(순증잔액)|기업예수금(순증잔액)|기업예수금(순증잔액)|기업예수금(순증잔액)|"	
	  +"기업저비용성예수금(합산)|기업저비용성예수금(합산)|"                                     
	  +"기업저비용성예수금(반기평잔)|기업저비용성예수금(반기평잔)|기업저비용성예수금(반기평잔)|기업저비용성예수금(반기평잔)|" 
	  +"기업저비용성예수금(월중평잔)|기업저비용성예수금(월중평잔)|기업저비용성예수금(월중평잔)|기업저비용성예수금(월중평잔)|" 	  
	  +"개인예수금(합산)|개인예수금(합산)|"                                     
	  +"개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|" 
	  ...
	  //비이자 31 							
	  +"신탁사업(합산)|신탁사업(합산)|신탁사업(합산)|신탁사업(합산)|신탁사업(합산)|" 
	  +"공제/펀드/카드|공제/펀드/카드|"  
	...
	strHeader2 = 
	  ...
	  //비이자 31
	  +"목표|실적|달성률|평점/배점|그룹내순위|"               // 5 신탁사업(합산)	      
