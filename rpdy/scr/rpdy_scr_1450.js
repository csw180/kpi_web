...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
        		...
        		//	}
        		//}
        	mySheet.DoSearch("rpdy.scr.rpdy_scr_1450.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=1"+"&metrogb="+metrogb);
...
function setGrid2022H()
{
    ...
    var strHeader0 = "점번호|점명|PG명|" // 3
                 +"개인 저비용성증대|개인 저비용성증대|개인 저비용성증대|개인 저비용성증대|개인 저비용성증대|개인 저비용성증대|" // 6
         		     +"기업 저비용성증대|기업 저비용성증대|기업 저비용성증대|기업 저비용성증대|기업 저비용성증대|기업 저비용성증대|" // 6
         		     ;
         			 
    var strHeader1 = "점번호|점명|PG명|" // 3
                 +"MMDA실적\n(A)|핵심실적\n(B)|핵심순증실적 1.5배\n(C)|합산실적\n(D)=(A+C)|목표\n(E)|달성률\n(F)=(D/E)|" // 6
         		     +"MMDA실적\n(A)|핵심실적\n(B)|핵심순증실적 1.5배\n(C)|합산실적\n(D)=(A+C)|목표\n(E)|달성률\n(F)=(D/E)|" // 6
         		     ;
