...
<%  
    ...
    String      leftmenu_name    = "디지털판매 신규우량고객"; 
    String      htm_title        = "일일 고객수증대 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1410.js"></script>
