<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - 고객평가 - 신규대출금고객 실적
'프로그램 ID  : rpdy_scr_14000.jsp
'프로그램 명  : 신규대출금고객
'프로그램개요 : 신규대출금고객 
'작   성   자 : 이우석
'작   성   일 : 2021.02.09
...
<%  
    ...
    String      leftmenu_name    = "신규대출금고객"; 
    String      htm_title        = "일일 신규대출금고객"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1400.js"></script>
