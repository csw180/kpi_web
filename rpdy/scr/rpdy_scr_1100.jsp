...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - 고객평가
'프로그램 ID  : rpdy_scr_1100.jsp
'프로그램 명  : 디지털고객 신규비이자고객
'프로그램개요 : 디지털고객 신규비이자고객
'작   성   자 : 이상용
'작   성   일 : 2021.02.19
====================================================================
'수정자/수정일:
...
<%  
    ...
    String      leftmenu_name    = "디지털판매 신규비이자고객"; 
    String      htm_title        = "일일 신규비이자고객 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1100.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
    	 // 전산정보부 및 성과 담당자
         hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1100.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
    } else {
         hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1100.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
    }
}
