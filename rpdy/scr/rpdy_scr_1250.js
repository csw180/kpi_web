...
//                    }
            ...
            mySheet.DoSearch("rpdy.scr.rpdy_scr_1250.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb="+sergb+"&metrogb="+metrogb);
...
function setGrid2021H()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
   ...
   var headers = [ { Text:"점번호|점명|PG명|보증서대출\n(A)|소액대출\n(소호모형)(B)|소호상품대출(C)|최종실적\n(D)=(A+B+C)|목표\n(E)|달성률\n(F)=(D/E)", Align:"Center"} ];
