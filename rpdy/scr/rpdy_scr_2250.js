...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            if(baseday >= '20170701') {
              if(isRoleEnable != '1') { 
//              	alert('2017년도 하반기 일일성과(전략사업) 자료는 차후 오픈 예정입니다.');
//              	break;
              }	
            }         
            mySheet.DoSearch("rpdy.scr.rpdy_scr_2250.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=0"+"&metrogb="+metrogb);
