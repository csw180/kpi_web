...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
        		...
        		//	}
        		//}
        	mySheet.DoSearch("rpdy.scr.rpdy_scr_2440.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=1"+"&metrogb="+metrogb+"&haeksgb=3");
...
function setGrid2022H()
{
  	...
  	// 상위 GRID에 대한 속성정보 설정
    var strHeader0 = "점번호|기업금융지점장|기업금융지점장|PG명|" // 4
                 +"저비용성증대|저비용성증대|저비용성증대|저비용성증대|저비용성증대|" // 5
         		     ;
         			 
    var strHeader1 = "점번호|직원번호|성명|PG명|" // 4
                 +"MMDA실적\n(A)|핵심순증실적 1.5배\n(B)|최종실적\n(C)|목표\n(D)|달성률\n(E)=(C/D)|" // 5
         		     ;
