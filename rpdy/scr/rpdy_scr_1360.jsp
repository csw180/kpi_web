<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - 신규기업대출금고객
'프로그램 ID  : rpdy_scr_1360.jsp
'프로그램 명  : 신규기업대출금고객
'프로그램개요 : 신규기업대출금고객 
'작   성   자 : 유용욱
'작   성   일 : 2019.03.27
...
<%  
    ...
    String      leftmenu_name    = "신규기업대출금고객"; 
    String      htm_title        = "일일 신규기업대출금고객"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1360.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
    	 // 전산정보부 및 성과 담당자
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1360.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
    } else {
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1360.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
    }
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <td>
     <select name="metrogb" onchange="allDelDataGrid(mySheet);showUnitText('Point, %');"><option value="0">전체</option></select></td>
    <td class="al_R end">
