...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준일":           // 조회(상위 GRID)
            ...
            if(isRoleEnable == '1') {
            	 // 전산정보부 및 성과 담당자
                 hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1410.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
            } else {
                 hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1410.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
            }*/
            break;
        case "조회":             // 조회(상위 GRID)
        		...
        		//	}
        		//}
        	mySheet.DoSearch("rpdy.scr.rpdy_scr_1410.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=1"+"&metrogb="+metrogb);
...
function setGrid2022()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
    var strHeader0 = "점번호|점명|PG명|개인고객수|개인고객수|개인고객수|개인고객수|개인고객수|"
         		     +"기업고객수|기업고객수|기업고객수|기업고객수|기업고객수|";
