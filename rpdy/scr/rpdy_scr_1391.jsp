...
<%  
    ...
    String      htm_title        = "일일상품판매 실적 세부내역"; 
    String      actionname       = "";
    String      strErrMsg        = "";
    String      status           = "0";
    String      allRole          = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1391.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  ...
  <tr>
    ...
    <td class="nobor end" colspan="4">
     <select name="sergb" onchange="selectsergb()">
        <option value="00">전체</option>
        <option value="01">자동이체</option>
        <option value="02">교차판매확대</option>                           
     </select>
    </td>	     
  </tr>  
