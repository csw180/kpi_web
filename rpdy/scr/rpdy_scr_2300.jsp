<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 일일 부지점장(팀장) 관리지표
'프로그램 ID  : rpdy_scr_2300.jsp
'프로그램 명  : 일일 기업부지점장 관리지표
'프로그램개요 : 일일 기업부지점장 관리지표
'작   성   자 : 이해인
'작   성   일 : 2020.03.12
====================================================================
'수정자/수정일/수정사유: 유용욱/2020.04.06/메뉴명 변경
===============================================================--%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ include file="/module/jsp_header.inc"%>
<%  
    String      topmenu_name     = "부지점장(팀장) 관리지표";
    String      leftmenu_name    = "기업부지점장 A"; 
    String      htm_title        = "기업부지점장 A"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_2300.js"></script>
