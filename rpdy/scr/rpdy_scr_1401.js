...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
            ...
            mySheet.DoSearch("rpdy.scr.rpdy_scr_1401.do?hidden_key=9&baseday="+baseday+"&sergb=1&jumcode="+jumcode+"&searchCode="+searchCode+"&pg_url="+pg_url);
...
function setGrid2021H1()
{
   ...
   var headers = [ { Text:"고객번호|고객구분|잔액|반기평잔|평가금액|고객평가점수", Align:"Center"} ];
