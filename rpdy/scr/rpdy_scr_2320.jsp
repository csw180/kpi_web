<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 > RM(본부) > 주거래기업 실적
'프로그램 ID  : rpdy_scr_2320.jsp
'프로그램 명  : 주거래기업 실적
'프로그램개요 : 주거래기업 실적
'작   성   자 : 이상용
'작   성   일 : 2021.02.23
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_2320.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
     // 전산정보부 및 성과 담당자
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2320.do?hidden_key=9&baseday="+baseday+"&sergb=98");
    } else {
        hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2320.do?hidden_key=9&baseday="+baseday+"&sergb=99");
    }
}
...
function mySheet_OnChangeSum(Row){
	...
	if (document.frm.baseday.value >= '20210101') {
