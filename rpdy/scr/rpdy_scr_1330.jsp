<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - 신규기업예수금고객_금융본부
'프로그램 ID  : rpdy_scr_1330.jsp
'프로그램 명  : 신규기업예수금고객
'프로그램개요 : 신규기업예수금고객 
'작   성   자 : 유용욱
'작   성   일 : 2019.03.07
...
<%  
    ...
    String      leftmenu_name    = "신규예수금고객 실적(금융본부)"; 
    String      htm_title        = "일일 신규예수금고객 실적(금융본부)"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1330.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
    	 // 전산정보부 및 성과 담당자
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1330.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
    } else {
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1330.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
    }
}
