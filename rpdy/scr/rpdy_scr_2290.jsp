...
'프로그램 ID  : rpdy_scr_2290.jsp
'프로그램 명  : 일일 개인부지점장 관리지표
'프로그램개요 : 일일 개인부지점장 관리지표
'작   성   자 : 이해인
'작   성   일 : 2020.03.12
====================================================================
...
<%  
    ...
    String      leftmenu_name    = "개인부지점장"; 
    String      htm_title        = "개인부지점장 KPI"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_2290.js"></script>
