<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 일일 기업저비용성예수금 실적
'프로그램 ID  : rpdy_scr_2270.jsp
'프로그램 명  : 일일 기업저비용성예수금 실적
'프로그램개요 : 일일 기업저비용성예수금 실적
'작   성   자 : 유용욱
'작   성   일 : 2019.08.06
====================================================================
'수정자/수정일:
...
<%  
    ...
    String      htm_title        = "일일 기업저비용성예수금 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1370.js"></script>
...
function mySheet_OnChangeSum(Row){
    ...
    if (document.frm.baseday.value >= '20200101') { // lhi
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <th>Peer Group</th>
    <td colspan="3">
    	<select name="pgcode" onchange="allDelDataGrid(mySheet);selectpgcode();">
