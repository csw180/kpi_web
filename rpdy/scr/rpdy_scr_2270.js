...
function selectsubchk()
{
	...
	if (baseday >= '20220101') {    	   	      
		if (subChk) { 									// 세부내역 체크 전        	
			/* -------- 영업점 기준 -------- */			// 세부내역 체크 전_영업점 (개인금융KPI) 3367 (1)
		    // 상품판매 3
		    ...
		    /* -------- 영업점 기준 -------- */			// 세부내역 체크 후_영업점 (개인금융KPI) 3367 (2)
			// 상품판매 3
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
           ...
           //   }	
           // }        
            mySheet.DoSearch("rpdy.scr.rpdy_scr_2270.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&metrogb="+metrogb);
...
function setGrid2022()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	strHeader1 =  
	  ...
	  "점번호|점명|PG명|팀구분\n(개인/기업)|순위|소관업무 합산실적|"
	  //고객관계 8
	  +"상품판매|상품판매|상품판매|상품판매|신규예금고객(개인)|신규예금고객(개인)|신규예금고객(개인)|신규예금고객(개인)|"          
	  //성장성 27
	  +"개인예수금(합산)|" 
...
function setGrid2021H()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
	...
	strHeader1 = 
	  ...
	  "점번호|점명|PG명|팀구분\n(개인/기업)|순위|소관업무 합산실적|"
	  //고객관계 8
	  +"상품판매|상품판매|상품판매|상품판매|신규예금 고객|신규예금 고객|신규예금 고객|신규예금 고객|"          
	  //성장성 18
	  +"개인예수금(합산)|" 
	  +"개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|개인예수금(반기평잔)|"                               
	  +"개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|개인예수금(순증잔액)|"  
