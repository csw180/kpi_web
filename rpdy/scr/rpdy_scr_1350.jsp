<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 일일 개인저비용성예수금 실적
'프로그램 ID  : rpdy_scr_1350.jsp
'프로그램 명  : 일일 개인저비용성예수금 실적
'프로그램개요 : 일일 개인저비용성예수금 실적
'작   성   자 : 유용욱
'작   성   일 : 2019.03.19
====================================================================
'수정자/수정일:
...
<%  
    ...
    String      htm_title        = "일일 개인저비용성예수금 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1350.js"></script>
