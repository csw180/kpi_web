...
====================================================================
'수정자 / 수 정 일 / 수정사유
'유용욱 / 20180824 / 2018년 하반기 성과기준 반영
===============================================================--%>
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1040.js"></script>
...
function mySheet_OnSearchEnd(Code,Msg){
	...
	if  (document.frm.baseday.value >= '20220701') {		
		mySheet.SetCellValue(mySheet.HeaderRows(),10,(mySheet.GetCellValue(mySheet.HeaderRows(),8) / mySheet.GetCellValue(mySheet.HeaderRows(), 9) * 100 ).toFixed(1),0);
		mySheet.SetCellValue(mySheet.HeaderRows(),15,(mySheet.GetCellValue(mySheet.HeaderRows(),13) / mySheet.GetCellValue(mySheet.HeaderRows(), 14) * 100 ).toFixed(1),0);
		...
		mySheet.SetCellValue(mySheet.HeaderRows(),13,(mySheet.GetCellValue(mySheet.HeaderRows(),11) / mySheet.GetCellValue(mySheet.HeaderRows(), 12) * 100 ).toFixed(1),0);
		...
		mySheet.SetCellValue(mySheet.HeaderRows(),11,(mySheet.GetCellValue(mySheet.HeaderRows(),9) / mySheet.GetCellValue(mySheet.HeaderRows(), 10) * 100 ).toFixed(1),0);
	} else if  (document.frm.baseday.value >= '20200101') {
		mySheet.SetCellValue(mySheet.HeaderRows(),7,(mySheet.GetCellValue(mySheet.HeaderRows(),5) / mySheet.GetCellValue(mySheet.HeaderRows(), 6) * 100 ).toFixed(1),0);
		mySheet.SetCellValue(mySheet.HeaderRows(),10,(mySheet.GetCellValue(mySheet.HeaderRows(),8) / mySheet.GetCellValue(mySheet.HeaderRows(), 9) * 100 ).toFixed(1),0);
	} else if  (document.frm.baseday.value >= '20190701') {
		mySheet.SetCellValue(mySheet.HeaderRows(),9,(mySheet.GetCellValue(mySheet.HeaderRows(),7) / mySheet.GetCellValue(mySheet.HeaderRows(), 8) * 100 ).toFixed(1),0);
...
function mySheet_OnChangeSum(Row){
	if  (document.frm.baseday.value >= '20210701') {		
		...
		mySheet.SetCellValue(Row,11,mySheet.GetCellValue(Row,9) / mySheet.GetCellValue(Row, 10) * 100 ,0);
	} else if  (document.frm.baseday.value >= '20200101') {
		mySheet.SetCellValue(Row,7,mySheet.GetCellValue(Row,5) / mySheet.GetCellValue(Row, 6) * 100 ,0);
		mySheet.SetCellValue(Row,10,mySheet.GetCellValue(Row,8) / mySheet.GetCellValue(Row, 9) * 100 ,0);
	} else if  (document.frm.baseday.value >= '20190701') {
