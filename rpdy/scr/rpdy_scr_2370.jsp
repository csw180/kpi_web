<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 > 프로모션 > 성과증대 프로모션 RM
'프로그램 ID  : rpdy_scr_2370.jsp
'프로그램 명  : 성과증대 프로모션 RM
'프로그램개요 : 성과증대 프로모션 RM
'작   성   자 : 이상용
'작   성   일 : 2022.04.12
...
<%  
    ...
    String      leftmenu_name    = "성과유공"; 
    String      htm_title        = "KPI 성과유공 기업금융지점장"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_2370.js"></script>
...
function mySheet_OnChangeSum(Row){
        CellValue2(Row,6)  = CellValue(Row,5) / CellValue(Row, 4) * 100 ; 
        CellValue2(Row,9)  = CellValue(Row,8) / CellValue(Row, 7) * 100 ; 
        CellValue2(Row,12) = CellValue(Row,11) / CellValue(Row, 10) * 100 ; 
}
*/
