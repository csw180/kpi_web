...
//metrogbhiddenGrid에 대한 속성정보 설정
   ...
   metrogbhiddenGrid.InitHeaders(headers, mtrhdnInfo);
...
//              	break;
            ...
            mySheet.DoSearch("rpdy.scr.rpdy_scr_2240.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=0"+"&metrogb="+metrogb);
...
function setGrid2022()
{
	...
	let strHeader1 = "";
   	...
   	strHeader0 = "점번호|RM(본부)|RM(본부)|PG명|"
   		+"실적\n(A)|신탁사실적\n(B)|최종실적\n(C)=(A+B)|목표\n(D)|달성률\n(E)=(C/D)";
   
   	strHeader1 = "점번호|직원번호|성명|PG명|"
   		+"실적\n(A)|신탁사실적\n(B)|최종실적\n(C)=(A+B)|목표\n(D)|달성률\n(E)=(C/D)";
