...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "조회":             // 조회(상위 GRID)
			...
			mySheet.DoSearch("rpdy.scr.rpdy_scr_1060.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=1"+"&metrogb="+metrogb );
...
function initGrid()
{
    ...
    if (baseday >= '20200701') setGrid2020H2();
...
function setGrid2020H2()
{
  ...
  // 상위 GRID에 대한 속성정보 설정
   ...
   var msInfo    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   var msHeaders = [ { Text:"점번호|점명|PG명|실적\n(A)|목표\n(B)|달성률\n(C)=(A/B)|", Align:"Center"} ];
   mySheet.InitHeaders(msHeaders, msInfo);

   var msCols = [ {Type:"Text",     Hidden:0,  MinWidth:50,   Align:"Center",  ColMerge:1,   SaveName:"NONE" },
