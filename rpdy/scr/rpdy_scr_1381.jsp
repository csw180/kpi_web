...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 고객평가
'프로그램 ID  : rpdy_scr_1381.jsp
'프로그램 명  : 일일신규예수금고객 실적 세부내역
'프로그램개요 : 일일신규예수금고객 실적 세부내역
'작   성   자 : 유용욱
'작   성   일 : 2020.07.17
====================================================================
'수정자/수정일: 
...
<%  
    ...
    String      htm_title        = "일일신규예수금고객 실적 세부내역"; 
    String      actionname       = "";
    String      strErrMsg        = "";
    String      status           = "0";
    String      allRole          = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1381.js"></script>
