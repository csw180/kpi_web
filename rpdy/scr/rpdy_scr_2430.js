...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준일":           // 조회(상위 GRID)
            ...
            if(isRoleEnable == '1') {
             // 전산정보부 및 성과 담당자
               hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2430.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");               
            } else {
               hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2430.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
            }
			*/
            break;
        case "조회":             // 조회(상위 GRID)
...
//            }
            if (pgcode != '16') {
                mySheet.DoSearch("rpdy.scr.rpdy_scr_2430.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb="+sergb+"&metrogb="+metrogb+"&kngb=3"); 
            } else {
...
function setGrid2022H()
{
    ...
    strHeader0 = "점번호|기업금융지점장|기업금융지점장|PG명|" // 4
      +"개인핵심\n순증실적\n3배\n(A)|신탁사제외\n순증실적\n(B)|신탁사\n순증실적 50%\n(C)|반영실적\n(D)|펌뱅킹\n월중평잔 실적\n(E)|펌뱅킹\n기준실적\n(F)|펌뱅킹\n순증실적\n(G)=(E-F)|"
      +"경리나라\n월중평잔 실적\n(H)|경리나라\n기준실적\n(I)|경리나라\n순증실적\n(J)=(H-I)|최종실적\n(K)=(D+G+J)|최종목표\n(L)|달성률\n(M)=(K/L)|";
        
    strHeader1 = "점번호|직원번호|성명|PG명|" // 4
      +"개인핵심\n순증실적\n3배\n(A)|신탁사제외\n순증실적\n(B)|신탁사\n순증실적 50%\n(C)|반영실적\n(D)|펌뱅킹\n월중평잔 실적\n(E)|펌뱅킹\n기준실적\n(F)|펌뱅킹\n순증실적\n(G)=(E-F)|"
      +"경리나라\n월중평잔 실적\n(H)|경리나라\n기준실적\n(I)|경리나라\n순증실적\n(J)=(H-I)|최종실적\n(K)=(D+G+J)|최종목표\n(L)|달성률\n(M)=(K/L)|";
...
function setGrid2022()
{
    ...
    strHeader0 = "점번호|RM(본부)|RM(본부)|PG명|" // 4
      +"개인핵심\n순증실적\n3배\n(A)|기업핵심\n순증실적\n(B)|펌뱅킹\n월중평잔 실적\n(C)|펌뱅킹\n기준실적\n(D)|펌뱅킹\n순증실적\n(E)=(C-D)|"
      +"경리나라\n월중평잔 실적\n(F)|경리나라\n기준실적\n(G)|경리나라\n순증실적\n(H)=(F-G)|최종실적\n(I)=(A+B+E+H)|최종목표\n(J)|달성률\n(K)=(I/J)|";
