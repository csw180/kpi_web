<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - RM신규기업대출금금고객
'프로그램 ID  : rpdy_scr_2250.jsp
'프로그램 명  : RM 신규기업대출금고객
'프로그램개요 : RM 신규기업대출금고객
'작   성   자 : 유용욱
'작   성   일 : 2019.03.27
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_2250.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
    // 전산정보부 및 성과 담당자
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2250.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
    } else {
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_2250.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
    }
}
...
function mySheet_OnSearchEnd(Code, Msg){
	...
	if (!isFinite(mySheet.GetCellValue(mySheet.HeaderRows(), mySheet.LastCol()))) mySheet.SetCellValue(mySheet.HeaderRows(),mySheet.LastCol(), 0);
}    
