...
<%  
    ...
    String      leftmenu_name    = "기업금융 KPI"; 
    String      htm_title        = "기업금융 KPI"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="rpdy/scr/rpdy_scr_2280.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <td>
	     <select name="metrogb" onchange="allDelDataGrid(mySheet);showUnitText(UnitText);">
	     	<option value="0">전체</option>
	     </select>
    </td>
