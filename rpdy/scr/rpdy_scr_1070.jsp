...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1070.js"></script>
...
function mySheet_OnSearchEnd(Code, Msg){
	...
	mySheet.SetMergeCell (mySheet.HeaderRows(), 0, 1,3);
		...
		if (document.frm.baseday.value >= '20220701') {
			num = (mySheet.GetCellValue(mySheet.HeaderRows(),5)  / mySheet.GetCellValue(mySheet.HeaderRows(), 6) * 100);
			if (!isFinite(num)) mySheet.SetCellValue(mySheet.HeaderRows(),7,0);
			else mySheet.SetCellValue(mySheet.HeaderRows(),7,num.toFixed(1),0);		
				
			num2 = (mySheet.GetCellValue(mySheet.HeaderRows(),8)  / mySheet.GetCellValue(mySheet.HeaderRows(), 9) * 100);
			if (!isFinite(num2)) mySheet.SetCellValue(mySheet.HeaderRows(),10,0);
			else mySheet.SetCellValue(mySheet.HeaderRows(),10,num2.toFixed(1),0);						
    } else	if (document.frm.baseday.value >= '20220101') {
			num = (mySheet.GetCellValue(mySheet.HeaderRows(),6)  / mySheet.GetCellValue(mySheet.HeaderRows(), 7) * 100);
			if (!isFinite(num)) mySheet.SetCellValue(mySheet.HeaderRows(),8,0);
			else mySheet.SetCellValue(mySheet.HeaderRows(),8,num.toFixed(1),0);		
