...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1260.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
     // 전산정보부 및 성과 담당자
        hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1260.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=98");
    } else {
        hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1260.do?hidden_key=9&baseday="+baseday+"&pgcode="+pgcode+"&sergb=99");
    }
}
...
function mySheet_OnSearchEnd(Code, Msg){
	...
	if (mySheet.GetCellValue(mySheet.HeaderRows(), 10)==0) return;
	var num = mySheet.GetCellValue(mySheet.HeaderRows(),9) / mySheet.GetCellValue(mySheet.HeaderRows(), 10) * 100
	mySheet.SetCellValue(mySheet.HeaderRows(),11, num.toFixed(1),0);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <td colspan="2"><select name="pgcode" onchange="initGrid()"><option value="0">전체</option></select></td>
