<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 일일 핵심예수금합산 
'프로그램 ID  : rpdy_scr_1440.jsp
'프로그램 명  : 일일 핵심예수금합산 실적
'프로그램개요 : 일일 핵심예수금합산 실적
'작   성   자 : 이상용
'작   성   일 : 2022.01.24
====================================================================
'수정자/수정일:
...
<%  
    ...
    String      htm_title        = "일일 핵심예수금합산 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1440.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  <tr> 
    ...
    <td colspan="3">
    	<select name="pgcode" onchange="selectpgcode()" class="select">
  ...
  <tr> 
    ...
    <td colspan="4" class="table11"> <input type="checkbox" name="subChk" onclick="javascript:selectsubchk();"> </td> -->
  </tr>
</table>
