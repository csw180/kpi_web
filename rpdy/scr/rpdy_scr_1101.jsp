...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 영업점보고서 - 고객평가
'프로그램 ID  : rpdy_scr_1101.jsp
'프로그램 명  : 디지털 신규비이자고객 실적 세부내역
'프로그램개요 : 디지털 신규비이자고객 실적 세부내역
'작   성   자 : 이상용
'작   성   일 : 2021.08.09
====================================================================
'수정자/수정일: 
...
<%  
    ...
    String      htm_title        = "디지털 신규비이자고객 실적 세부내역"; 
    String      actionname       = "";
    String      strErrMsg        = "";
    String      status           = "0";
    String      allRole          = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1101.js"></script>
...
function hiddGridmon_OnSearchEnd(Code, Msg){
    ...
    if(isRoleEnable == '1') {
       // IT담당자 및 성과 담당자
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1101.do?hidden_key=9&baseday="+baseday+"&sergb=98");
    } else {
       hiddenGrid.DoSearch("rpdy.scr.rpdy_scr_1101.do?hidden_key=9&baseday="+baseday+"&sergb=99" );
    }
}
