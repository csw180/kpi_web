<%--===============================================================
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 일일성과보고서 - 신규예수금고객
'프로그램 ID  : rpdy_scr_1380.jsp
'프로그램 명  : 신규예수금고객
'프로그램개요 : 신규예수금고객 
'작   성   자 : 유용욱
'작   성   일 : 2019.08.09
...
<%  
    ...
    String      leftmenu_name    = "신규예수금고객 실적"; 
    String      htm_title        = "일일 신규예수금고객 실적"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/rpdy/scr/rpdy_scr_1380.js"></script>
