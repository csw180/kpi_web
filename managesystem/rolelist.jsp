...
<%@ page import="tpms.managesystem.menu.Role_EventResponse"%>
<% 
    ...
    String strErrMsg="";
    String cEvent="";
    Role_EventResponse eventResponse;
    int manager=0;
    ...
    try {
        ...
        if (piex !=null) {
            ...
            eventResponse=(Role_EventResponse)request.getAttribute("Role_EventResponse");
