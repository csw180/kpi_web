...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 운영관리 - 본부입력
'프로그램 ID  : main_scr_6012.jsp
'프로그램 명  : SPC수탁업무수수료 확정해제 처리
'프로그램개요 : SPC수탁업무수수료 확정해제 처리
'작   성   자 : 조형석
'작   성   일 : 2008.05.02
====================================================================
'수정자/수정일 :
...
<% 
    ...
    try
    {
       if(hidden_key.equals("2")) {
         rc = cp.InputProc("wp_main_확정해제관리","2,"+basemonth+","+branch_no+","+"SPC수탁업무수수료"+","+v_commit+","+haengwon_no);
       } 
       rs = cp.callProc("wp_main_확정해제관리","4,"+basemonth+","+branch_no+","+"SPC수탁업무수수료"+","+v_commit+","+haengwon_no);
       if(rs != null)                       
       {
%>
<SHEET>
