...
'프로그램 ID  : main_scr_4590.jsp
'프로그램 명  : RM(영업점) 지정업무 Upload
'프로그램개요 : RM(영업점) 지정업무 Upload
'작   성   자 : 양인찬
'작   성   일 : 2021.08.19
====================================================================
'수정자/수정일   : 수정사유 
...
<%  
    ...
    String      htm_title        = "RM(영업점) 지정관리업무"; 
    String      actionname       = "";
    String      haengwon_no      = "";
    String      strErrMsg        = "";
    String      status           = "0";
...
<script language="javascript" src="/kpi/main/scr/main_scr_4590.js"></script>
