...
<script language="javascript" src="/kpi/main/scr/main_scr_1040.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabletype2 pdLR">
  	<tr> 
	    ...
	    <td align="right" class="end">
	      	...
	      	<span class="btn_Grd" style="cursor:pointer" border="0" id="btn_entry" name="btn_entry" onclick="javascript:doAction('등록');">등록</span>
	      	<span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:doAction('엑셀내려받기');">엑셀</span>
	      	<span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:selectcommit(2);" id="btn_list1" name="btn_list1" style="cursor:pointer">확정</span>
	      	<span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:selectcommit(3);" id="btn_list2" name="btn_list2" style="cursor:pointer">확정취소</span>
	    </td>
  	</tr>  
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" cells class="pdLR mgT5">
  	<tr>
    	<td>
       		<div id="sheetObj"></div>
    	</td>
