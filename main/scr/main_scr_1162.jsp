...
<% 
    ...
    try
    {
       if(hidden_key.equals("2")) {
         rc = cp.InputProc("wp_main_확정해제관리","2,"+basemonth+","+branch_no+","+"고객관리자코드관리"+","+v_commit+","+haengwon_no);
       } 
       rs = cp.callProc("wp_main_확정해제관리","4,"+basemonth+","+branch_no+","+"고객관리자코드관리"+","+v_commit+","+haengwon_no);
       if(rs != null)                       
       {
%>
<SHEET>
