...
====================================================================
'수정자/수 정 일 : 수정사유
'하진영/20120906 : 박준우과장요청 영업점직원이 목표조회 할경우 해당 보고서에
'                  사업부소속코드 (1:개인,2:기업 그외 "") 한글표시, 기준실적상품분류코드 삭제
===============================================================--%>
...
<%  
    ...
    try {
        ...
        //전산정보부와 금기부(주관부서)를 제외한 경우 보고서 컬럼 확인을 위해
...
<script language="javascript" src="/kpi/main/scr/main_scr_3020.js"></script>
