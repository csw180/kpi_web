...
<script language="javascript" src="/kpi/main/scr/main_scr_1070.js"></script>
  	...
  	<tr>
    	<td align="right" class="topB">
    	  <span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:doAction('조회');">조회</span>
      	  <span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:doAction('엑셀올리기');" name="btn_upload">업로드</span>
   	  	  <span class="btn_Grd" style="cursor:pointer" border="0" onclick="javascript:doAction('저장');" name="btn_entry">등록</span>
