...
<% 
    ...
    try
    {
       if(hidden_key.equals("2")) {
         rc = cp.InputProc("wp_main_확정해제관리","2,"+basemonth+","+branch_no+","+"10대조달처등록"+","+v_commit+","+haengwon_no);
       } 
       rs = cp.callProc("wp_main_확정해제관리","4,"+basemonth+","+branch_no+","+"10대조달처등록"+","+v_commit+","+haengwon_no);
       if(rs != null)                       
       {
%>
<SHEET>
