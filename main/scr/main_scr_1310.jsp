...
<script language="javascript" src="/kpi/main/scr/main_scr_1310.js"></script>
  	...
  	<tr>
	    ...
	    <td class="nobor">
	    	<select name="sjgubun" class="select" onchange="initGrid()">
	             ...
	             <option value="1">Corporate Deal</option>                                       
            </select>
        </td>
