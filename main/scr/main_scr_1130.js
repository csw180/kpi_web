...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":                    // 조회
             mySheet.DoSearch("main.scr.main_scr_1131.do?hidden_key=9&basemonth=" + basemonth); 
             break;
        ...
        case "엑셀올리기":              // 엑셀올리기
             ...
             if (basemonth < '201301') 
             {  alert("2012년 이전데이터는 2013년 layout변경으로 등록 불가합니다!");
             	  return;
             }
...
/*                if(mySheet.CellValue(i, 3) < 31 || mySheet.CellValue(i, 3) > 48 ) 
                {
                    alert('[' + i + ']번째의 Row의 ['+ mySheet.CellValue(i, 3) +']합동구분이 정당한 합동이 아닙니다.\n\n' +      
                          '확인 후 다시 Excel 업로드하시기 바랍니다.');
             ...
             var isSuccess = mySheet.DoSave("main.scr.main_scr_1131.do", {Param : "hidden_key=2&basemonth=" + basemonth });
...
function selectcommit(chk)
{
    ...
    // 확정구분 조회
    if (chk== 1) {
       hiddenGrid.DoSearch(encodeURI("comm.scr.comm_scr_9098.screen?hidden_key=1&v_commit=0&scrName=기준실적등록&basemonth="+basemonth));
       //InputButtControl(1);
    // 확정 시킴
    } else if (chk== 2) {
       hiddenGrid.DoSearch(encodeURI("comm.scr.comm_scr_9098.screen?hidden_key=2&v_commit=1&scrName=기준실적등록&basemonth="+basemonth));
       //InputButtControl(3);
    // 확정취소 시킴
    } else if (chk== 3) {    
       hiddenGrid.DoSearch(encodeURI("comm.scr.comm_scr_9098.screen?hidden_key=2&v_commit=2&scrName=기준실적등록&basemonth="+basemonth));
       //InputButtControl(1);
    }
}
...
function  setGrid2013()
{
    ...
    // 상위 GRID에 대한 속성정보 설정
   	let strHeader="상태|작업기준년월|점번호|KPI코드|사업부소속코드|< 기준실적 >\n상품분류코드|"
   		+"기준실적|반기1st월기준실적|반기2nd월기준실적|반기3rd월기준실적|반기4th월기준실적|반기5th월기준실적|반기6th월기준실적";
   	...
   	var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             ...
             {Type:"Float",       Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_6",    CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_7",    CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_8",    CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_9",    CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_10",   CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_11",   CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             {Type:"Float",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_12",   CalcLogic:"",   Format:"Float",     PointCount:0,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 } ];                                
...
function  setGrid()
{
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"상태|작업기준년월|점번호|KPI코드|사업부소속코드|<기준실적>\n상품분류코드|기준실적", Align:"Center"} ];
   	mySheet.InitHeaders(headers, info);
   	...
   	var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             ...
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Center",  SaveName:"v_sv_4",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:7 },
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Center",  SaveName:"v_sv_5",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:7 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_6",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_7",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_8",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_9",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_10",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_11",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:1, MinWidth:130,  Align:"Right",   SaveName:"v_sv_12",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 } ];
