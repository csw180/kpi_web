...
<%     return;
    ...
    try
    {
        if(rs==null){
            ...
            System.out.println("rs==null : hidden_key = " + hidden_key);
...
%>
    <TR>
      ...
      <TD><![CDATA[<%=rs.getString("변경전사업부소속코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("변경후사업부소속코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("사업부분류코드").trim()%>]]></TD>
