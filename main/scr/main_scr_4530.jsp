...
'프로그램 ID  : main_scr_4530.jsp
'프로그램 명  : RM(영업점) 배점 Upload
'프로그램개요 : RM(영업점) 배점 Upload
'작   성   자 : 조형석
'작   성   일 : 2014.07.21
====================================================================
'수정자/수정일   : 수정사유 
...
<script language="javascript" src="/kpi/main/scr/main_scr_4530.js"></script>
...
function mySheet_OnSaveEnd(Code, Msg) {    
    showMsg(Code, Msg);
    mySheet.DoSearch("main.scr.main_scr_4531.do?hidden_key=9&basemonth="+document.frm.basemonth.value+"&jumcode="+document.frm.jumcode.value);
}
</script>
