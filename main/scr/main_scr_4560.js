...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":                    // 조회
             mySheet.DoSearch("main.scr.main_scr_4561.do?hidden_key=9&basemonth=" + basemonth); 
             break;
...
*/
        ...
        case "저장":                    // 저장
             ...
             concatPrimaryKeys(mySheet, "1|2|3|4|5|6");
             
             //var isSuccess = mySheet.DoSave("main.scr.main_scr_4561.do?hidden_key=2&basemonth=" + basemonth, "", "", false);
			var isSuccess = mySheet.DoSave("main.scr.main_scr_4561.do", {Param : "hidden_key=2&basemonth=" + basemonth});
...
function  setGrid()
{
   ...
   let strHeader="상태|작업기준년월|직원번호|점번호|KPI코드|사업부소속코드|< 기준실적 >\n상품분류코드|"
   	+"반기1st월기준실적|반기2nd월기준실적|반기3rd월기준실적|반기4th월기준실적|반기5th월기준실적|반기6th월기준실적|기준실적";
   ...
   var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             ...
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_8",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_9",    CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_10",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_11",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_12",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Int",       Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_13",   CalcLogic:"",   Format:"Integer",     PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
