...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 운영관리 - 데이타입력
'프로그램 ID  : main_scr_1120.jsp
'프로그램 명  : 사업부변경고객 Upload
'프로그램개요 : 사업부변경고객 Upload
'작   성   자 : 하진영
'작   성   일 : 2011.01.
====================================================================
'수정자/수정일 :
...
<script language="javascript" src="/kpi/main/scr/main_scr_1120.js"></script>
...
function mySheet_OnMouseMove(Button, Shift, X, Y) {
  //실명번호 풍선도움말 설정    
  if(mySheet.MouseCol == 2 && mySheet.MouseRow > 0){
    	mySheet.SetToolTipText(mySheet.MouseRow(),mySheet.MouseCol(),mySheet.GetCellValue(mySheet.MouseRow(),7));
  }
}
