...
function LoadPage()
{
	createIBSheet2(  document.getElementById("sheetObj"),"mySheet", "990px", getDefaultHeight($("#sheetObj"), 100));	// 연구위원인력 DATA
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"구분|직원번호|직원명|발령일|종료일|화면조회권한부여", Align:"Center"} ];
   	...
   	var cols = [ {Type:"Status",    Hidden:1, MinWidth:100,  Align:"Center",  SaveName:"v_sv_0",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:6 },
             ...
             {Type:"Text",      Hidden:0,  MinWidth:130,  Align:"Center",  SaveName:"v_sv_4",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:8 },
...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":                    // 조회
             mySheet.DoSearch("main.scr.main_scr_5011.do?hidden_key=9&basemonth=" + basemonth); 
             break;
        ...
        case "등록":                    //등록
            ...
            mySheet.DoSearch("main.scr.main_scr_5011.do?hidden_key=1"
                                                          +"&basemonth="+basemonth
                                                          +"&emnm="+emnm
                                                          +"&stdate="+stdate
                                                          +"&enddate="+enddate
        ...
        case "변경":                                                           //변경
            ...
            mySheet.DoSearch("main.scr.main_scr_5011.do?hidden_key=2"
                                                          +"&basemonth="+basemonth
                                                          +"&emnm="+emnm
                                                          +"&stdate=" +stdate
                                                          +"&enddate="+enddate
                                                          +"&oldemnm="+mySheet.GetCellValue(v_selrow, 1)
                                                          +"&oldstdate=" +mySheet.GetCellValue(v_selrow, 3)
                                                          +"&oldenddate="+mySheet.GetCellValue(v_selrow, 4)
                                                          ); 
            //doAction('조회');                                                          
        ...
        case "삭제":   
            ...
            mySheet.DoSearch("main.scr.main_scr_5011.do?hidden_key=3"
                                                          +"&basemonth="+basemonth
                                                          +"&emnm="+emnm
                                                          +"&stdate=" +stdate
                                                          +"&enddate="+enddate
        ...
        case "엑셀올리기":           // 엑셀올리기
             ...
             break;
        case "엑셀저장":             // 엑셀저장
             var Row = mySheet.ColValueDup("1|3");
             if(Row>-1)
             {
			...
			var isSuccess = mySheet.DoSave("main.scr.main_scr_5011.do", {Param : strParam }); 
             if(!isSuccess) return;
