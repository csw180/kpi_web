...
%>
    <TR>
      ...
      <TD><![CDATA[<%=rs.getString("여수신구분").trim()%>]]></TD>         
      <TD><![CDATA[<%=rs.getString("점번호").trim()%>]]></TD>         
      <TD><![CDATA[<%=rs.getString("계좌번호").trim()%>]]></TD>   
      <TD><![CDATA[<%=rs.getString("계정과목코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("관리회계상품코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("고객번호").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("신규일자").trim()%>]]></TD>                  
      <TD><![CDATA[<%=rs.getString("월말잔액").trim()%>]]></TD>                  
      <TD><![CDATA[<%=rs.getString("월중평잔").trim()%>]]></TD>                  
      <TD><![CDATA[<%=rs.getString("분기평잔").trim()%>]]></TD>                  
      <TD><![CDATA[<%=rs.getString("반기평잔").trim()%>]]></TD>                  
      <TD><![CDATA[<%=rs.getString("기중평잔").trim()%>]]></TD>                  
    </TR> 
<%
            } /* end while */
            strMsg = "조회 완료 되었습니다.";
