...
%>
     <TR>
      ...
      <TD><![CDATA[<%=rs.getString("취급관리점번호").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("취급관리점차감비율").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("소개점번호").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("소개점인정비율").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("비고").trim()%>]]></TD>
    </TR>
<%
            } /* end while */
        strMsg = "조회 완료 되었습니다.";
