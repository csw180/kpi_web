...
function LoadPage()
{
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"상태|작업기준년월|PG코드|KPI코드|점번호|배점", Align:"Center"} ];
   	...
   	var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             ...
             {Type:"Float",     Hidden:0,  MinWidth:100,  Align:"Right",   SaveName:"v_sv_5",    CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0,   EditLen:12 } ];
...
/*                if(mySheet.CellValue(i, 3) < 31 || mySheet.CellValue(i, 3) > 48 ) 
             ...
             //var isSuccess = mySheet.DoSave("main.scr.main_scr_3031.do?hidden_key=2&basemonth=" + basemonth, "", "", false); 
             var isSuccess = mySheet.DoSave("main.scr.main_scr_3031.do", {Param : "hidden_key=2&basemonth=" + basemonth}); 
             if(!isSuccess) return;
