...
'주  시 스 템 : 성과 관리시스템
'서브  시스템 : 운영관리 - 데이터 입력
'프로그램 ID  : main_scr_1140.jsp
'프로그램 명  : 영업점실적조정  Upload
'프로그램개요 : 영업점실적조정  Upload
'작   성   자 : 하진영
'작   성   일 : 2011.01.
====================================================================
'수정자/수정일 :
...
<script language="javascript" src="/kpi/main/scr/main_scr_1140.js"></script>
