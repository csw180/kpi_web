...
function doAction(sAction)
{
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":                 // 조회
             mySheet.DoSearch("main.scr.main_scr_4581.do?hidden_key=9&basemonth="+basemonth+"&jumcode="+jumcode); 
             break;
        case "엑셀내려받기":            // 엑셀내려받기
             inqText       = new Array();
             inqText[0]    = new Array();
...
*/
        ...
        case "저장":                    // 저장
             ...
             //var isSuccess = mySheet.DoSave("main.scr.main_scr_4581.do?hidden_key=1&basemonth=" + basemonth, "", "", false); 
             var isSuccess = mySheet.DoSave("main.scr.main_scr_4581.do", {Param : "hidden_key=1&basemonth=" + basemonth}); 
             if(!isSuccess) return;
             break;
    }
}
...
function setGrid2015()
{
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"상태|작업기준년월|직원번호|소속점번호|계좌번호|계정과목코드|대상구분", Align:"Center"} ];
   	...
   	var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             ...
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Center",  SaveName:"v_sv_4",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:20 },
             ...
             {Type:"Combo",      Hidden:0,  MinWidth:100,  Align:"Center",  SaveName:"v_sv_6",    CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 } ];
             // {Type:"Combo",     Hidden:0, MinWidth:120,  Align:"Left",    SaveName:"v_sv_7",    CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 } 
    
   	mySheet.InitColumns(cols);

   	mySheet.SetColProperty(6, {ComboText:"지정관리실적차감|지정관리실적가산|신규실적차감|신규실적가산|기존신규실적차감|기존신규실적가산", ComboCode:"1|2|3|4|5|6"} );
