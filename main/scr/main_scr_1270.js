...
function LoadPage()
{
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"상태|작업기준년월|계좌관리점번호|계정과목코드|계좌번호|계좌관리점인정비율", Align:"Center"} ];
   	...
   	var cols = [ {Type:"Status",    Hidden:0, MinWidth:100,  Align:"Center",  SaveName:"v_status",  KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0 },
             {Type:"Text",      Hidden:0,  MinWidth:80,   Align:"Center",  SaveName:"v_sv_1",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:6 },
             ...
             {Type:"Text",      Hidden:0,  MinWidth:150,  Align:"Center",  SaveName:"v_sv_4",    KeyField:1,   CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:1 },
             {Type:"Float",     Hidden:0,  MinWidth:100,  Align:"Right",   SaveName:"v_sv_5",    CalcLogic:"",   Format:"Float",       PointCount:2,   UpdateEdit:0,   InsertEdit:0 } ];
...
*/			
        ...
        case "저장":                    // 저장
             ...
             //var isSuccess = mySheet.DoSave("main.scr.main_scr_1271.do?hidden_key=2&basemonth=" + basemonth, "", "", false);
             var isSuccess = mySheet.DoSave("main.scr.main_scr_1271.do", {Param : "hidden_key=2&basemonth=" + basemonth});
