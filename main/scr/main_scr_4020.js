...
function LoadPage()
{
    ...
    createIBSheet2(  document.getElementById("hiddenGridObj2"),"hiddenGrid2", "200px", "400px"); // 계정과목코드 이용해 계정명 가져오기
    ...
    // 상위 GRID에 대한 속성정보 설정
   	...
   	var info    = { Sort:1, ColMove:1, ColResize:1, HeaderCheck:1 };
   	var headers = [ { Text:"상태|고객명|고객번호|계좌번호|계정과목코드|계정명|계좌신규일|마케팅\n주관부서", Align:"Center"} ];
   	...
   	var cols = [ {Type:"Status",    Hidden:1, MinWidth:100,  Align:"Center",  SaveName:"v_sv_0",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:6 },
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Left",    SaveName:"v_sv_1",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Right",   SaveName:"v_sv_2",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:9 },
             {Type:"Text",      Hidden:0,  MinWidth:100,  Align:"Right",   SaveName:"v_sv_3",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
             {Type:"Text",      Hidden:0,  MinWidth:130,  Align:"Right",   SaveName:"v_sv_4",  CalcLogic:"",   Format:"",            PointCount:-1,  UpdateEdit:0,   InsertEdit:0,   EditLen:12 },
...
function doAction(sAction)
{
    ...
    costomerno = document.frm.costomerno.value;
    accunt     = document.frm.accunt.value;
    accuntcode = document.frm.accuntcode.value;
    accdate    = document.frm.accdate.value;
    maketjum   = document.frm.maketjum.value;
    ...
    switch(sAction)
    {
        ...
        case "기준년월":             // 조회(상위 GRID)
            ...
            break;
        case "조회":                    // 조회
             mySheet.DoSearch("main.scr.main_scr_4021.do?hidden_key=9&basemonth=" + basemonth); 
             //mySheet.FitSize(false, true);
             isEnableSave        = true;
             break;
        ...
        case "등록":                    //등록
            ...
            mySheet.DoSearch("main.scr.main_scr_4021.do?hidden_key=1"
                                                          +"&basemonth="+basemonth
                                                          +"&costomerno="+costomerno
                                                          +"&accunt="+accunt
        ...
        case "변경":                                                           //변경
            ...
            mySheet.DoSearch("main.scr.main_scr_4021.do?hidden_key=2"
                                                          +"&basemonth="+basemonth
                                                          +"&costomerno="+costomerno
                                                          +"&accunt="+accunt
                                                          +"&accuntcode="+accuntcode
                                                          +"&accdate="+accdate
                                                          +"&maketjum="+maketjum
                                                          +"&oldcostomerno="+mySheet.GetCellValue(v_selrow, 2)
                                                          +"&oldaccunt="+mySheet.GetCellValue(v_selrow, 3)
                                                          +"&oldaccuntcode="+mySheet.GetCellValue(v_selrow, 4)
                                                          +"&oldaccdate="+mySheet.GetCellValue(v_selrow, 6)
                                                          +"&oldmaketjum="+mySheet.GetCellValue(v_selrow, 7)
                                                          ); 
            //doAction('조회');                                                          
        ...
        case "삭제":   
            ...
            mySheet.DoSearch("main.scr.main_scr_4021.do?hidden_key=3"
                                                          +"&basemonth="+basemonth
                                                          +"&costomerno="+costomerno
                                                          +"&accunt="+accunt
                                                          +"&accuntcode="+accuntcode
        ...
        case "엑셀올리기":           // 엑셀올리기
             ...
             break;
        case "엑셀저장":             // 엑셀저장
             var Row = mySheet.ColValueDup("2|3|4");
             if(Row>-1)
             {
...
//             var isSuccess = mySheet.DoSave("main.scr.main_scr_4021.do?hidden_key=4"
//                                                                  +"&basemonth="+basemonth
//                                                                  +"&costomerno="+costomerno
//                                                                  +"&accunt="+accunt
//                                                                  +"&accuntcode="+accuntcode
...
//                                                                  , "", "", false); 
				...
				let strParam = "hidden_key=4"
                                  ...
                                  +"&accdate="+accdate
                                  +"&maketjum="+maketjum;
				var isSuccess = mySheet.DoSave("main.scr.main_scr_4021.do", {Param : strParam}); 
...
function selectcommit(chk)
{
    ...
    // 확정여부 조회
    if (chk== 1) {
       hiddenGrid1.DoSearch("kpi.main.main_4022.screen?hidden_key=1&v_commit=0&basemonth="+basemonth);
       //InputButtControl(1);
    // 확정 시킴
    } else if (chk== 2) {
       hiddenGrid1.DoSearch("kpi.main.main_4022.screen?hidden_key=2&v_commit=1&basemonth="+basemonth);
       //InputButtControl(3);
    // 확정취소 시킴
    } else if (chk== 3) {    
       hiddenGrid1.DoSearch("kpi.main.main_4022.screen?hidden_key=2&v_commit=2&basemonth="+basemonth);
       //InputButtControl(1);
    }
