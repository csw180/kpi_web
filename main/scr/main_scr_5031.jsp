...
%>
    <TR>
      ...
      <TD><![CDATA[<%=rs.getString("IS계정과목코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("계정세과목코드").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("권유자직원번호").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("후선보임PI반영이익").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("후선보임PI이익구분").trim()%>]]></TD>
      <TD><![CDATA[<%=rs.getString("후선보임PI추가여부").trim()%>]]></TD>
