...
<% 
    ...
    try
    {
       if(hidden_key.equals("2")) {
         rc = cp.InputProc("UP_KPI_O_S_확정해제관리","2,"+basemonth+","+branch_no+","+"개인별PI권유직원변경"+","+v_commit+","+haengwon_no);
       } 
       rs = cp.callProc("UP_KPI_O_S_확정해제관리","4,"+basemonth+","+branch_no+","+"개인별PI권유직원변경"+","+v_commit+","+haengwon_no);
       if(rs != null)                       
       {
%>
<SHEET>
