...
<%@ page import="tpms.news.scr.news_scr_1112_EventResponse"%>
<% 
    ...
    news_scr_1112_EventResponse eventResponse;
    int manager=0;
    ...
    try 
    {
        ...
        {
            eventResponse=(news_scr_1112_EventResponse)request.getAttribute("news_scr_1112_EventResponse");
