...
<%@ page import="tpms.news.scr.news_scr_1113_EventResponse"%>
<% 
    ...
    news_scr_1113_EventResponse eventResponse;
    int manager=0;
    ...
    try 
    {
        ...
        {
            eventResponse=(news_scr_1113_EventResponse)request.getAttribute("news_scr_1113_EventResponse");
...
%>
    <TR>
      ...
      <TD><![CDATA[<%=rs.getString("파일명").trim()%>]]></TD>   
    </TR> 
<%          
            }
%>
